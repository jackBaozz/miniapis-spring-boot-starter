...
| Azure DevOps | `AzureDevopsClient` | `https://docs.microsoft.com/en-us/rest/api/azure/devops` | REST API 请求/响应对的 Azure DevOps 基本组件 | `apiKey` |
| CDNJS | `CdnjsClient` | `https://api.cdnjs.com/libraries/jquery` | CDNJS 上的图书馆信息 | `免 Key` |
| ApiFlash | `ApiflashClient` | `https://apiflash.com/` | 为开发者提供基于 Chrome 的屏幕截图 API | `apiKey` |
| CORS Proxy | `CorsProxyClient` | `https://github.com/burhanuday/cors-proxy` | 使用此代理作为中间人来解决可怕的 CORS 错误 | `免 Key` |
| Base | `BaseClient` | `https://www.base-api.io/` | 构建快速后端 | `apiKey` |
| Blynk-Cloud | `BlynkCloudClient` | `https://blynkapi.docs.apiary.io/#` | 从 Blynk IoT Cloud 控制 IoT 设备 | `apiKey` |
| Docker Hub | `DockerHubClient` | `https://docs.docker.com/docker-hub/api/latest/` | 与 Docker Hub 交互 | `apiKey` |
| API Grátis | `ApiGrTisClient` | `https://apigratis.com.br/` | 多种服务和公共 API | `免 Key` |
| Userstack | `UserstackClient` | `https://userstack.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers` | 安全用户代理字符串查找 JSON API | `OAuth` |
| Blitapp | `BlitappClient` | `https://blitapp.com/api/` | 安排网页屏幕截图并将其同步到您的云端 | `apiKey` |
| Ghost | `GhostClient` | `https://ghost.org/` | 将发布的内容获取到您的网站、应用程序或其他嵌入式媒体中 | `apiKey` |
| Databricks | `DatabricksClient` | `https://docs.databricks.com/dev-tools/api/latest/index.html` | 管理您的 databricks 帐户、集群、笔记本、作业和工作区的服务 | `apiKey` |
| Contentful Images | `ContentfulImagesClient` | `https://www.contentful.com/developers/docs/references/images-api/` | 用于检索图像并将变换应用于图像 | `apiKey` |
...
| Bitbucket | `BitbucketClient` | `https://developer.atlassian.com/bitbucket/api/2/reference/` | 比特桶API | `OAuth` |
| Google Fonts | `GoogleFontsClient` | `https://developers.google.com/fonts/docs/developer_api` | Google Fonts 提供的所有系列的元数据 | `apiKey` |
| Agify.io | `AgifyIoClient` | `https://agify.io` | 从名字估计年龄 | `免 Key` |
| Gitlab | `GitlabClient` | `https://docs.gitlab.com/ee/api/` | 以编程方式自动化 GitLab 交互 | `OAuth` |
| Browshot | `BrowshotClient` | `https://browshot.com/api/documentation` | 轻松制作任何屏幕尺寸、任何设备的网页屏幕截图 | `apiKey` |
...
| Host.io | `HostIoClient` | `https://host.io` | 面向开发人员的域数据 API | `apiKey` |
| Google Firebase | `GoogleFirebaseClient` | `https://firebase.google.com/docs` | Google 的移动应用程序开发平台，可帮助构建、改进和发展应用程序 | `apiKey` |
...
| Google Docs | `GoogleDocsClient` | `https://developers.google.com/docs/api/reference/rest` | 用于读取、写入和格式化 Google Docs 文档的 API | `OAuth` |
| jsDelivr | `JsdelivrClient` | `https://github.com/jsdelivr/data.jsdelivr.com` | jsDelivr CDN 上的软件包信息和下载统计信息 | `免 Key` |
| Google Sheets | `GoogleSheetsClient` | `https://developers.google.com/sheets/api/reference/rest` | 用于读取、写入和格式化 Google Sheets 数据的 API | `OAuth` |
| Google Keep | `GoogleKeepClient` | `https://developers.google.com/keep/api/reference/rest` | 用于读取、写入和格式化 Google Keep 笔记的 API | `OAuth` |
| IPify | `IpifyClient` | `https://www.ipify.org/` | 一个简单的 IP 地址 API | `免 Key` |
| Hasura | `HasuraClient` | `https://hasura.io/opensource/` | 具有内置授权的 GraphQL 和 REST API 引擎 | `apiKey` |
| Google Slides | `GoogleSlidesClient` | `https://developers.google.com/slides/api/reference/rest` | 用于读取、写入和格式化 Google 幻灯片演示文稿的 API | `OAuth` |
| IBM Text to Speech | `IbmTextToSpeechClient` | `https://cloud.ibm.com/docs/text-to-speech/getting-started.html` | 将文本转换为语音 | `apiKey` |
...
| GETPing | `GetpingClient` | `https://www.getping.info` | 通过简单的 GET 请求触发电子邮件通知 | `apiKey` |
...
| Gorest | `GorestClient` | `https://gorest.co.in/` | 用于测试和原型设计的在线 REST API | `OAuth` |
| IP2WHOIS Information Lookup | `Ip2WhoisInformationLookupClient` | `https://www.ip2whois.com/` | WHOIS域名查询 | `apiKey` |
| Icanhazip | `IcanhazipClient` | `https://major.io/icanhazip-com-faq/` | IP地址API | `免 Key` |
| ipfind.io | `IpfindIoClient` | `https://ipfind.io` | IP 地址或任何域名的地理位置以及一些其他有用信息 | `apiKey` |
| Hunter | `HunterClient` | `https://hunter.io/api` | 用于域名搜索、专业电子邮件查找器、作者查找器和电子邮件验证器的 API | `apiKey` |
...
| Postman | `PostmanClient` | `https://www.postman.com/postman/workspace/postman-public-workspace/documentation/12959542-c8142d51-e97c-46b6-bd77-52bb66712c9a` | 用于测试 API 的工具 | `apiKey` |
| Logs.to | `LogsToClient` | `https://logs.to/` | 生成日志 | `apiKey` |
| GeekFlare | `GeekflareClient` | `https://apidocs.geekflare.com/docs/geekflare-api` | 为网站的重要测试和监控方法提供众多功能 | `apiKey` |
...
| MAC address vendor lookup | `MacAddressVendorLookupClient` | `https://macaddress.io/api` | 检索有关给定 MAC 地址或 OUI 的供应商详细信息和其他信息 | `apiKey` |
| OpenAPIHub | `OpenapihubClient` | `https://hub.openapihub.com/` | 一体化 API 平台 | `X-Mashape-Key` |
...
| PageCDN | `PagecdnClient` | `https://pagecdn.com/docs/public-api` | PageCDN 上的 javascript、css 和字体库的公共 API | `apiKey` |
| Micro DB | `MicroDbClient` | `https://m3o.com/db` | 简单的数据库服务 | `apiKey` |
| ScraperApi | `ScraperapiClient` | `https://www.scraperapi.com` | 轻松构建可扩展的网络抓取工具 | `apiKey` |
| import.io | `ImportIoClient` | `http://api.docs.import.io/` | 从网站或 RSS 源检索结构化数据 | `apiKey` |
| Sonar | `SonarClient` | `https://github.com/Cgboal/SonarSearch` | 项目声纳 DNS 枚举 API | `免 Key` |
| Screenshot | `ScreenshotClient` | `https://www.abstractapi.com/website-screenshot-api` | 以编程方式对任何网站的网页进行屏幕截图 | `apiKey` |
| ScrapingDog | `ScrapingdogClient` | `https://www.scrapingdog.com/` | 用于网页抓取的代理 API | `apiKey` |
...
| OneSignal | `OnesignalClient` | `https://documentation.onesignal.com/docs/onesignal-api` | 适用于推送通知、电子邮件、短信和应用内的自助式客户互动解决方案 | `apiKey` |
...
| ScreenshotAPI.net | `ScreenshotapiNetClient` | `https://screenshotapi.net/` | 创建像素完美的网站屏幕截图 | `apiKey` |
| Netlify | `NetlifyClient` | `https://docs.netlify.com/api/get-started/` | Netlify 是可编程网络的托管服务 | `OAuth` |
| ScrapeNinja | `ScrapeninjaClient` | `https://scrapeninja.net` | 使用 Chrome 指纹和住宅代理抓取 API | `apiKey` |
...
| scrapestack | `ScrapestackClient` | `https://scrapestack.com/` | 实时、可扩展的代理和网页抓取 REST API | `apiKey` |
| Nationalize.io | `NationalizeIoClient` | `https://nationalize.io` | 估计名字的国籍 | `免 Key` |
| Open Page Rank | `OpenPageRankClient` | `https://www.domcop.com/openpagerank/` | 使用Page Rank算法计算和比较不同网站指标的API | `apiKey` |
| Pusher Beams | `PusherBeamsClient` | `https://pusher.com/beams` | 适用于 Android 和 iOS 的推送通知 | `apiKey` |
| ProxyKingdom | `ProxykingdomClient` | `https://proxykingdom.com` | 旋转代理 API，针对每个请求生成一个工作代理 | `apiKey` |
| ScrapingAnt | `ScrapingantClient` | `https://scrapingant.com` | 使用简单的 API 进行无头 Chrome 抓取 | `apiKey` |
| Statically | `StaticallyClient` | `https://statically.io/` | 为开发者提供的免费 CDN | `免 Key` |
| Heroku | `HerokuClient` | `https://devcenter.heroku.com/articles/platform-api-reference/` | REST API 以编程方式创建应用程序、配置附加组件并在 Heroku 上执行其他任务 | `OAuth` |
| SonarQube | `SonarqubeClient` | `https://sonarcloud.io/web_api` | SonarQube REST API 用于检测错误、代码异味和安全漏洞 | `OAuth` |
| GitHub | `GithubClient` | `https://docs.github.com/en/free-pro-team@latest/rest` | 以编程方式使用 GitHub 存储库、代码和用户信息 | `OAuth` |
| StackExchange | `StackexchangeClient` | `https://api.stackexchange.com/` | 开发者问答论坛 | `OAuth` |
| serpstack | `SerpstackClient` | `https://serpstack.com/` | 实时准确的 Google 搜索结果 API | `apiKey` |
| QR code | `QrCodeClient` | `https://www.qrtag.net/api/` | 创建易于阅读的 QR 码和 URL 缩短器 | `免 Key` |
| ZenRows | `ZenrowsClient` | `https://www.zenrows.com/` | Web Scraping API 绕过反机器人解决方案，同时提供 JS 渲染和旋转代理 | `apiKey` |
| QR code | `QrCodeClient` | `http://goqr.me/api/` | 生成并解码/读取二维码图形 | `免 Key` |
| Talordata | `TalordataClient` | `https://docs.talordata.com/` | 来自主要搜索引擎的 SERP 数据，可免费试用 | `apiKey` |
| Serialif Color | `SerialifColorClient` | `https://color.serialif.com/` | 颜色转换、互补、灰度和对比文本 | `免 Key` |
| Supportivekoala | `SupportivekoalaClient` | `https://developers.supportivekoala.com/` | 使用模板自动生成图像 | `apiKey` |
| Thunderbit | `ThunderbitClient` | `https://thunderbit.com/docs/introduction` | 将网页提取为 Markdown 或人工智能应用程序的结构化数据 | `apiKey` |
| SavePage.io | `SavepageIoClient` | `https://www.savepage.io` | 一个免费的 RESTful API，用于对任何桌面或移动网站进行屏幕截图 | `apiKey` |
...
| ProxyCrawl | `ProxycrawlClient` | `https://proxycrawl.com` | 抓取和爬行反验证码服务 | `apiKey` |
| SHOUTCLOUD | `ShoutcloudClient` | `http://shoutcloud.io/` | 全大写即服务 | `免 Key` |
| WebScraping.AI | `WebscrapingAiClient` | `https://webscraping.ai/` | 具有内置代理和 JS 渲染的 Web Scraping API | `apiKey` |
| scraperBox | `ScraperboxClient` | `https://scraperbox.com/` | 无法检测到的网页抓取 API | `apiKey` |
...
| Sheetsu | `SheetsuClient` | `https://sheetsu.com/` | 轻松集成谷歌表格 | `apiKey` |
| Tyk | `TykClient` | `https://tyk.io/open-source/` | API和服务管理平台 | `apiKey` |
| isitdownstatus | `IsitdownstatusClient` | `https://isitdownstatus.com` | 检查网站和在线服务当前是否已关闭 | `免 Key` |
| OpenGraphr | `OpengraphrClient` | `https://opengraphr.com/docs/1.0/overview` | 从 URL 检索 Open Graph 数据的 API 非常简单 | `apiKey` |
...
| Brawl Stars | `BrawlStarsClient` | `https://developer.brawlstars.com` | 《荒野乱斗》游戏信息 | `apiKey` |
...
| Destiny The Game | `DestinyTheGameClient` | `https://bungie-net.github.io/multi/index.html` | Bungie 平台 API | `apiKey` |
| Disney | `DisneyClient` | `https://disneyapi.dev` | 迪士尼人物信息 | `免 Key` |
| Fortnite | `FortniteClient` | `https://fortnitetracker.com/site-api` | 《堡垒之夜》统计数据 | `apiKey` |
...
| Clash of Clans | `ClashOfClansClient` | `https://developer.clashofclans.com` | 部落冲突游戏信息 | `apiKey` |
| GamerPower | `GamerpowerClient` | `https://www.gamerpower.com/api-read` | 游戏赠品追踪器 | `免 Key` |
| Clash Royale | `ClashRoyaleClient` | `https://developer.clashroyale.com` | 皇室战争游戏信息 | `apiKey` |
| Hearthstone | `HearthstoneClient` | `http://hearthstoneapi.com/` | 炉石卡牌信息 | `X-Mashape-Key` |
| Hypixel | `HypixelClient` | `https://api.hypixel.net/` | Hypixel 玩家统计 | `apiKey` |
| FunTranslations | `FuntranslationsClient` | `https://api.funtranslations.com/` | 将文本翻译成有趣的语言 | `免 Key` |
| Humble Bundle | `HumbleBundleClient` | `https://rapidapi.com/Ziggoto/api/humble-bundle` | Humble Bundle 当前的捆绑包 | `apiKey` |
...
| Dota 2 | `Dota2Client` | `https://docs.opendota.com/` | 提供有关 Dota 2 玩家统计数据、比赛统计数据、排名的信息 | `apiKey` |
| IGDB.com | `IgdbComClient` | `https://api-docs.igdb.com` | 视频游戏数据库 | `apiKey` |
| Humor | `HumorClient` | `https://humorapi.com` | 幽默、笑话和模因 | `apiKey` |
...
| mod.io | `ModIoClient` | `https://docs.mod.io` | 跨平台模组 API | `apiKey` |
...
| Giant Bomb | `GiantBombClient` | `https://www.giantbomb.com/api/documentation` | 电子游戏 | `apiKey` |
| Path of Exile | `PathOfExileClient` | `https://www.pathofexile.com/developer/docs` | 流亡之路游戏信息 | `OAuth` |
...
| Guild Wars 2 | `GuildWars2Client` | `https://wiki.guildwars2.com/wiki/API:Main` | 激战 2 游戏信息 | `apiKey` |
| Minecraft Server Status | `MinecraftServerStatusClient` | `https://api.mcsrvstat.us` | 用于获取有关 Minecraft 服务器信息的 API | `免 Key` |
| Lichess | `LichessClient` | `https://lichess.org/api` | 访问 Lichess 上的用户、游戏、谜题等所有数据 | `OAuth` |
| RAWG.io | `RawgIoClient` | `https://rawg.io/apidocs` | 适用于 50 个平台（包括手机）的 500,000 多款游戏 | `apiKey` |
| Halo | `HaloClient` | `https://developer.haloapi.com/` | 光环 5 和光环战争 2 信息 | `apiKey` |
| Raider | `RaiderClient` | `https://raider.io/api` | 提供魔兽世界中Raiding和Mythic+内容的详细角色和公会排名 | `免 Key` |
| Eve Online | `EveOnlineClient` | `https://esi.evetech.net/ui` | 第三方开发者文档 | `OAuth` |
...
| Mario Kart Tour | `MarioKartTourClient` | `https://mario-kart-tour-api.herokuapp.com/` | 适用于车手、卡丁车、滑翔机和课程的 API | `OAuth` |
| MMO Games | `MmoGamesClient` | `https://www.mmobomb.com/api` | MMO 游戏数据库、新闻和赠品 | `免 Key` |
| Steam | `SteamClient` | `https://steamapi.xpaw.me/` | Steam Web API 文档 | `apiKey` |
...
| Jokes One | `JokesOneClient` | `https://jokes.one/api/joke/` | 每日笑话和可通过 REST API 访问的大类笑话 | `apiKey` |
| Battle.net | `BattleNetClient` | `https://develop.battle.net/documentation/guides/getting-started` | 暗黑破坏神 III、炉石传说、星际争霸 II 和魔兽世界游戏数据 API | `OAuth` |
...
| quizapi.io | `QuizapiIoClient` | `https://quizapi.io/` | 访问各种测验问题 | `apiKey` |
...
| Marvel | `MarvelClient` | `https://developer.marvel.com` | 漫威漫画 | `apiKey` |
| Hytale | `HytaleClient` | `https://hytale-api.com/` | Hytale 博客文章和职位 | `免 Key` |
| PUBG | `PubgClient` | `https://developer.pubg.com/` | 访问游戏内 PUBG 数据 | `apiKey` |
...
| Riot Games | `RiotGamesClient` | `https://developer.riotgames.com/` | 英雄联盟游戏信息 | `apiKey` |
| Magic The Gathering | `MagicTheGatheringClient` | `http://magicthegathering.io/` | 万智牌游戏信息 | `免 Key` |
| Tebex | `TebexClient` | `https://docs.tebex.io/plugin/` | Tebex API 提供有关游戏购买的信息 | `X-Mashape-Key` |
...
| SuperHeroes | `SuperheroesClient` | `https://superheroapi.com` | 来自所有宇宙的所有超级英雄和恶棍数据都在一个 API 下 | `apiKey` |
...
| PandaScore | `PandascoreClient` | `https://developers.pandascore.co/` | 电子竞技比赛及结果 | `apiKey` |
| SpaceTradersAPI | `SpacetradersapiClient` | `https://spacetraders.io?rel=pub-apis` | 一款可玩的星际空间交易 MMOAPI | `OAuth` |
...
| Wargaming.net | `WargamingNetClient` | `https://developers.wargaming.net/` | Wargaming.net 信息和统计数据 | `apiKey` |
...
| Apiip | `ApiipClient` | `https://apiip.net/` | 通过IP地址获取位置信息 | `apiKey` |
...
| ipapi.com | `IpapiComClient` | `https://ipapi.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers` | 实时地理定位和反向 IP 查找 REST API | `apiKey` |
| GeoJS | `GeojsClient` | `https://www.geojs.io/` | 与 ChatOps 集成的 IP 地理定位 | `免 Key` |
| Google Maps | `GoogleMapsClient` | `https://developers.google.com/maps/` | 基于 Google 地图数据创建/自定义数字地图 | `apiKey` |
| Google Earth Engine | `GoogleEarthEngineClient` | `https://developers.google.com/earth-engine/` | 用于全球范围环境数据分析的云平台 | `apiKey` |
...
| CountryStateCity | `CountrystatecityClient` | `https://countrystatecity.in/` | JSON、SQL、XML、YAML 和 CSV 格式的世界国家、州、地区、省份、城市和城镇 | `apiKey` |
| Battuta | `BattutaClient` | `http://battuta.medunes.net` | （国家/地区/城市）级联位置 API | `apiKey` |
| Geokeo | `GeokeoClient` | `https://geokeo.com` | Geokeo 地理编码服务 - 每天有 2500 个免费 API 请求 | `免 Key` |
| IPstack | `IpstackClient` | `https://ipstack.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers` | 通过 IP 地址定位和识别网站访问者 | `apiKey` |
| adresse.data.gouv.fr | `AdresseDataGouvFrClient` | `https://adresse.data.gouv.fr` | 法国地址数据库、地理编码和反向 | `免 Key` |
| BigDataCloud | `BigdatacloudClient` | `https://www.bigdatacloud.com/ip-geolocation-apis` | 提供快速准确的 IP 地理定位 API 以及安全检查和置信区域 | `apiKey` |
...
| IP Geolocation | `IpGeolocationClient` | `https://www.abstractapi.com/ip-geolocation-api` | 根据 IP 定位网站访问者 | `apiKey` |
| ip-api | `IpApiClient` | `https://ip-api.com/docs` | 使用 IP 地址或域查找位置 | `免 Key` |
| IPInfoDB | `IpinfodbClient` | `https://www.ipinfodb.com/api` | 免费地理定位工具和 API，用于通过 IP 地址查找国家、地区、城市和时区 | `apiKey` |
...
| Geocodify.com | `GeocodifyComClient` | `https://geocodify.com/` | 地址的全球地理编码、地理解析和自动完成 | `apiKey` |
| GeoDataSource | `GeodatasourceClient` | `https://www.geodatasource.com/web-service` | 使用纬度和经度坐标对城市名称进行地理编码 | `apiKey` |
...
| ipstack | `IpstackClient` | `https://ipstack.com/` | 通过 IP 地址定位和识别网站访问者 | `apiKey` |
| ipgeolocation | `IpgeolocationClient` | `https://ipgeolocation.io/` | IP 地理定位 AP 免费计划每月 30k 请求 | `apiKey` |
...
| ApogeoAPI | `ApogeoapiClient` | `https://apogeoapi.com` | 针对国家、州、城市、IP 地理位置和实时汇率的捆绑 API | `apiKey` |
| IP2Location | `Ip2LocationClient` | `https://www.ip2location.com/web-service/ip2location` | IP 地理定位 Web 服务可获取超过 55 个参数 | `apiKey` |
| IP2Proxy | `Ip2ProxyClient` | `https://www.ip2location.com/web-service/ip2proxy` | 使用 IP 地址检测代理和 VPN | `apiKey` |
| Kakao Maps | `KakaoMapsClient` | `https://apis.map.kakao.com` | Kakao Maps 为韩国地图提供多个 API | `apiKey` |
| MapQuest | `MapquestClient` | `https://developer.mapquest.com/` | 获取绘制世界地图的工具和资源 | `apiKey` |
| Longdo Map | `LongdoMapClient` | `https://map.longdo.com/docs/` | 包含泰国详细地点和信息门户的交互式地图 | `apiKey` |
| HERE Maps | `HereMapsClient` | `https://developer.here.com` | 基于 HERE 地图数据创建/定制数字地图 | `apiKey` |
| Geoapify | `GeoapifyClient` | `https://www.geoapify.com/api/geocoding-api/` | 正向和反向地理编码、地址自动完成 | `apiKey` |
| SLF | `SlfClient` | `https://github.com/slftool/slftool.github.io/blob/master/API.md` | 德国城市、国家、河流、数据库 | `免 Key` |
| Mapbox | `MapboxClient` | `https://docs.mapbox.com/` | 创建/定制精美的数字地图 | `apiKey` |
| One Map, Singapore | `OneMapSingaporeClient` | `https://www.onemap.gov.sg/docs/` | 新加坡土地管理局针对新加坡地址的 REST API 服务 | `apiKey` |
| US ZipCode | `UsZipcodeClient` | `https://www.smarty.com/docs/cloud/us-zipcode-api` | 验证并附加任何美国邮政编码的数据 | `apiKey` |
...
| openrouteservice.org | `OpenrouteserviceOrgClient` | `https://openrouteservice.org/` | 路线、POI、等时线、地理编码（+反向）、海拔等 | `apiKey` |
...
| OpenCage | `OpencageClient` | `https://opencagedata.com` | 使用开放数据进行正向和反向地理编码 | `apiKey` |
...
| GeoDB Cities | `GeodbCitiesClient` | `http://geodb-cities-api.wirefreethought.com/` | 获取全球城市、地区、国家数据 | `apiKey` |
...
| Actinia Grass GIS | `ActiniaGrassGisClient` | `https://actinia.mundialis.de/api_docs/` | Actinia 是一个开源 REST API，用于使用 GRASS GIS 的地理数据 | `apiKey` |
| TomTom | `TomtomClient` | `https://developer.tomtom.com/` | 地图、路线、地点和交通 API | `apiKey` |
| Postali | `PostaliClient` | `https://postali.app/api` | 墨西哥 邮政编码 API | `免 Key` |
| Telize | `TelizeClient` | `https://rapidapi.com/fcambus/api/telize/` | Telize 提供来自任何 IP 地址的位置信息 | `apiKey` |
| IBGE | `IbgeClient` | `https://servicodados.ibge.gov.br/api/docs/` | IBGE（巴西地理与统计研究所）的综合服务 | `免 Key` |
| positionstack | `PositionstackClient` | `https://positionstack.com/` | 正向和反向批量地理编码 REST API | `apiKey` |
| Uebermaps | `UebermapsClient` | `https://uebermaps.com/api/v2` | 发现地图并与朋友分享 | `apiKey` |
...
| Geocod.io | `GeocodIoClient` | `https://www.geocod.io/` | 批量地址地理编码/反向地理编码 | `apiKey` |
| OpenStreetMap | `OpenstreetmapClient` | `http://wiki.openstreetmap.org/wiki/API` | 导航、地理定位和地理数据 | `OAuth` |
| Utah AGRC | `UtahAgrcClient` | `https://api.mapserv.utah.gov` | 用于对犹他州地址进行地理编码的犹他州 Web API | `apiKey` |
| ZipCodeAPI | `ZipcodeapiClient` | `https://www.zipcodeapi.com` | 美国邮政编码距离、半径和位置 API | `apiKey` |
| GeoApi | `GeoapiClient` | `https://api.gouv.fr/api/geoapi.html` | 法国地理数据 | `免 Key` |
| Yandex.Maps Geocoder | `YandexMapsGeocoderClient` | `https://yandex.com/dev/maps/geocoder` | 使用地理编码从对象的地址获取对象的坐标 | `apiKey` |
| Ziptastic | `ZiptasticClient` | `https://ziptasticapi.com/` | 获取任何美国邮政编码的国家、州和城市 | `免 Key` |
| LocationIQ | `LocationiqClient` | `https://locationiq.org/docs/` | 提供正向/反向地理编码和批量地理编码 | `apiKey` |
...
| Hirak IP to Country | `HirakIpToCountryClient` | `https://iplocation.hirak.site/` | 带国家代码、货币代码和货币名称的 IP 到位置，快速响应，无限请求 | `apiKey` |
...
| What3Words | `What3WordsClient` | `https://what3words.com` | 三个词作为全球难忘且独特的坐标 | `apiKey` |
...
| Gazette Data, UK | `GazetteDataUkClient` | `https://www.thegazette.co.uk/data` | 英国官方公共记录 API | `OAuth` |
| City, Helsinki | `CityHelsinkiClient` | `https://hri.fi/en_gb/` | 赫尔辛基(FI) 城市开放数据 | `免 Key` |
| Deutscher Bundestag DIP | `DeutscherBundestagDipClient` | `https://dip.bundestag.de/documents/informationsblatt_zur_dip_api_v01.pdf` | 此 API 提供对 DIP 实体（例如活动、人员、印刷材料）的读取访问权限 | `apiKey` |
...
| Data.gov | `DataGovClient` | `https://api.data.gov/` | 美国政府数据 | `apiKey` |
...
| CPFHub | `CpfhubClient` | `https://cpfhub.io` | 巴西 CPF 查找 — 返回任何 CPF 的全名、出生日期和性别 | `apiKey` |
| City, Gdańsk | `CityGdaSkClient` | `https://ckan.multimediagdansk.pl/en` | 格但斯克 (PL) 城市开放数据 | `免 Key` |
| National Park Service, US | `NationalParkServiceUsClient` | `https://www.nps.gov/subjects/developer/` | 数据来自美国国家公园管理局 | `apiKey` |
...
| City, Nantes Open Data | `CityNantesOpenDataClient` | `https://data.nantesmetropole.fr/pages/home/` | 南特(法国) 城市开放数据 | `apiKey` |
| Open Government, France | `OpenGovernmentFranceClient` | `https://www.data.gouv.fr/` | 法国政府开放数据 | `apiKey` |
...
| Code.gov | `CodeGovClient` | `https://code.gov` | 美国联邦政府开源和代码共享的主要平台 | `apiKey` |
...
| Open Government, New South Wales | `OpenGovernmentNewSouthWalesClient` | `https://api.nsw.gov.au/` | 新南威尔士州政府开放数据 | `apiKey` |
| FEC | `FecClient` | `https://api.open.fec.gov/developers/` | 有关联邦选举竞选捐款的信息 | `apiKey` |
...
| Open Government, Thailand | `OpenGovernmentThailandClient` | `https://data.go.th/` | 泰国政府开放数据 | `apiKey` |
...
| Gun Policy | `GunPolicyClient` | `https://www.gunpolicy.org/api` | 国际枪伤预防和政策 | `apiKey` |
...
| Open Government, Luxembourg | `OpenGovernmentLuxembourgClient` | `https://data.public.lu` | 卢森堡政府开放数据 | `apiKey` |
...
| Open Government, Estonia | `OpenGovernmentEstoniaClient` | `https://avaandmed.eesti.ee/instructions/opendata-dataset-api` | 爱沙尼亚政府开放数据 | `apiKey` |
...
| Open Government, Greece | `OpenGovernmentGreeceClient` | `https://data.gov.gr/` | 希腊政府开放数据 | `OAuth` |
...
| USA.gov | `UsaGovClient` | `https://www.usa.gov/developer` | 有关美国节目、活动、服务等的权威信息 | `apiKey` |
| UK Companies House | `UkCompaniesHouseClient` | `https://developer.company-information.service.gov.uk/` | 英国公司保存来自英国政府的数据 | `OAuth` |
...
| Open Government, India | `OpenGovernmentIndiaClient` | `https://data.gov.in/` | 印度政府开放数据 | `apiKey` |
...
| Amadeus for Developers | `AmadeusForDevelopersClient` | `https://developers.amadeus.com/self-service` | 旅游搜索 - 限制使用 | `OAuth` |
| Grab | `GrabClient` | `https://developer.grab.com/docs/` | 跟踪送货、乘车费用、付款和忠诚度积分 | `OAuth` |
| BIC-Boxtech | `BicBoxtechClient` | `https://docs.bic-boxtech.org/` | 全球集装箱船队的集装箱技术细节 | `OAuth` |
| BlaBlaCar | `BlablacarClient` | `https://dev.blablacar.com` | 搜索汽车共享行程 | `apiKey` |
| AZ511 | `Az511Client` | `https://www.az511.com/developers/doc` | 从 ADOT API 访问流量数据 | `apiKey` |
| Icelandic APIs | `IcelandicApisClient` | `http://docs.apis.is/` | 在冰岛境内或有关冰岛提供服务的开放 API | `免 Key` |
| Compare Flight Prices | `CompareFlightPricesClient` | `https://rapidapi.com/obryan-software-obryan-software-default/api/compare-flight-prices/` | 用于比较跨平台航班价格的 API | `apiKey` |
...
| apilayer aviationstack | `ApilayerAviationstackClient` | `https://aviationstack.com/` | 实时航班状态和全球航空数据API | `OAuth` |
| Land Transport Authority DataMall, Singapore | `LandTransportAuthorityDatamallSingaporeClient` | `https://datamall.lta.gov.sg/content/dam/datamall/datasets/LTA_DataMall_API_User_Guide.pdf` | 新加坡交通信息 | `apiKey` |
| ADS-B Exchange | `AdsBExchangeClient` | `https://www.adsbexchange.com/data/` | 访问任何和所有机载飞机的实时和历史数据 | `免 Key` |
| Navitia | `NavitiaClient` | `https://doc.navitia.io/` | 用于使用传输数据构建炫酷内容的开放 API | `apiKey` |
...
| Bay Area Rapid Transit | `BayAreaRapidTransitClient` | `http://api.bart.gov` | BART 的车站和预计抵达时间 | `apiKey` |
| Transport for Denver, US | `TransportForDenverUsClient` | `http://www.rtd-denver.com/gtfs-developer-guide.shtml` | 热电阻 | `免 Key` |
| Orizn Visa | `OriznVisaClient` | `https://visa.orizn.app` | 199 个国家/地区的签证要求，15 种语言的 39,000 多个护照-目的地对 | `apiKey` |
| GraphHopper | `GraphhopperClient` | `https://docs.graphhopper.com/` | 带有逐向指令的 A 到 B 路由 | `apiKey` |
| Transport for Belgium | `TransportForBelgiumClient` | `https://docs.irail.be/` | iRail API 是比利时公共火车交通的第三方 API | `免 Key` |
| Boston MBTA Transit | `BostonMbtaTransitClient` | `https://www.mbta.com/developers/v3-api` | MBTA 的车站和预计抵达时间 | `apiKey` |
| Sabre for Developers | `SabreForDevelopersClient` | `https://developer.sabre.com/guides/travel-agency/quickstart/getting-started-in-travel` | 旅游搜索 - 限制使用 | `apiKey` |
| Transport for Chicago, US | `TransportForChicagoUsClient` | `http://www.transitchicago.com/developers/` | 芝加哥交通管理局 (CTA) | `apiKey` |
| Tankerkoenig | `TankerkoenigClient` | `https://creativecommons.tankerkoenig.de/swagger/` | 德国实时汽油/柴油价格 | `apiKey` |
| CTS | `CtsClient` | `https://api.cts-strasbourg.eu/` | CTS实时API | `apiKey` |
| Transport for Finland | `TransportForFinlandClient` | `https://digitransit.fi/en/developers/` | 芬兰交通 API | `免 Key` |
| AIS Hub | `AisHubClient` | `http://www.aishub.net/api` | 任何配备 AIS 跟踪系统的海洋和内河船舶的实时数据 | `apiKey` |
...
| Schiphol Airport | `SchipholAirportClient` | `https://developer.schiphol.nl/` | 史基浦机场 | `apiKey` |
| Railway Transport for France | `RailwayTransportForFranceClient` | `https://www.digital.sncf.com/startup/api` | SNCF 公共 API | `apiKey` |
...
| Izi | `IziClient` | `http://api-docs.izi.travel/` | 为旅客提供的语音导览 | `apiKey` |
| Transport for Bordeaux, France | `TransportForBordeauxFranceClient` | `https://opendata.bordeaux-metropole.fr/explore/` | 波尔多大都会公共交通及更多（法国） | `apiKey` |
| Open Charge Map | `OpenChargeMapClient` | `https://openchargemap.org/site/develop/api` | 电动汽车充电地点的全球公共登记处 | `apiKey` |
| Transport for Switzerland | `TransportForSwitzerlandClient` | `https://opentransportdata.swiss/en/` | 瑞士官方公共交通开放数据 | `apiKey` |
...
| Transport for Sweden | `TransportForSwedenClient` | `https://www.trafiklab.se/api` | 公共交通消费者 | `OAuth` |
| Transport for Toronto, Canada | `TransportForTorontoCanadaClient` | `https://myttc.ca/developers` | 技术中心 | `免 Key` |
| Transport for Ottawa, Canada | `TransportForOttawaCanadaClient` | `https://www.octranspo.com/en/plan-your-trip/travel-tools/developers` | OC 传输 API | `apiKey` |
| Transport for UK | `TransportForUkClient` | `https://developer.transportapi.com` | 英国交通 API 和数据集 | `apiKey` |
...
| Tripadvisor | `TripadvisorClient` | `https://developer-tripadvisor.com/home/` | 对酒店、餐厅、景点或目的地的内容进行评级 | `apiKey` |
| Transport for Atlanta, US | `TransportForAtlantaUsClient` | `http://www.itsmarta.com/app-developer-resources.aspx` | 玛尔塔 | `免 Key` |
| Transport for Manchester, England | `TransportForManchesterEnglandClient` | `https://developer.tfgm.com/` | TfGM传输网络数据 | `apiKey` |
| Transport for Vancouver, Canada | `TransportForVancouverCanadaClient` | `https://developer.translink.ca/` | 运联 | `OAuth` |
...
| Transport for Washington, US | `TransportForWashingtonUsClient` | `https://developer.wmata.com/` | 华盛顿地铁交通 API | `OAuth` |
| Transport for London, England | `TransportForLondonEnglandClient` | `https://api.tfl.gov.uk` | 伦敦交通局API | `apiKey` |
| Uber | `UberClient` | `https://developer.uber.com/products` | 优步乘车请求和价格估算 | `OAuth` |
| Transport for Honolulu, US | `TransportForHonoluluUsClient` | `http://hea.thebus.org/api_info.asp` | 檀香山交通信息 | `apiKey` |
| Transport for Lisbon, Portugal | `TransportForLisbonPortugalClient` | `https://emel.city-platform.com/opendata/` | 有关巴士路线、停车位和交通的数据 | `apiKey` |
...
| Transport for Sao Paulo, Brazil | `TransportForSaoPauloBrazilClient` | `http://www.sptrans.com.br/desenvolvedores/api-do-olho-vivo-guia-de-referencia/documentacao-api/` | 特快专递 | `OAuth` |
| Transport for The Netherlands | `TransportForTheNetherlandsClient` | `http://www.ns.nl/reisinformatie/ns-api` | NS，仅限火车 | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| Binance | `BinanceClient` | `https://github.com/binance/binance-spot-api-docs` | 位于中国的加密货币交易交易所 | `apiKey` |
| Bitmex | `BitmexClient` | `https://www.bitmex.com/app/apiOverview` | 总部位于香港的实时加密货币衍生品交易平台 | `apiKey` |
...
| Bitfinex | `BitfinexClient` | `https://docs.bitfinex.com/docs` | 加密货币交易平台 | `apiKey` |
| Bybit | `BybitClient` | `https://bybit-exchange.github.io/docs/linear/#t-introduction` | 加密货币数据馈送和算法交易 | `apiKey` |
| CoinMarketCap | `CoinmarketcapClient` | `https://coinmarketcap.com/api/` | 加密货币价格 | `apiKey` |
| Coinlayer | `CoinlayerClient` | `https://coinlayer.com?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers` | 实时加密货币汇率 | `apiKey` |
| Bittrex | `BittrexClient` | `https://bittrex.github.io/api/v3` | 下一代加密货币交易平台 | `apiKey` |
| Blockchain | `BlockchainClient` | `https://www.blockchain.com/api` | 比特币支付、钱包和交易数据 | `apiKey` |
| CoinDCX | `CoindcxClient` | `https://docs.coindcx.com/` | 加密货币交易平台 | `apiKey` |
| Ethplorer | `EthplorerClient` | `https://github.com/EverexIO/Ethplorer/wiki/Ethplorer-API` | 以太坊代币、余额、地址、交易历史、合约和自定义结构 | `apiKey` |
| blockfrost Cardano | `BlockfrostCardanoClient` | `https://blockfrost.io/` | 与卡尔达诺主网和多个测试网的交互 | `apiKey` |
| Coinigy | `CoinigyClient` | `https://coinigy.docs.apiary.io` | 与 Coinigy 账户直接交互并进行交易 | `apiKey` |
...
| BtcTurk | `BtcturkClient` | `https://docs.btcturk.com/` | 实时加密货币数据、图表和允许买卖的 API | `apiKey` |
| Gateio | `GateioClient` | `https://www.gate.io/api2` | API提供现货、保证金、期货交易操作 | `apiKey` |
| Indodax | `IndodaxClient` | `https://github.com/btcid/indodax-official-api-docs` | 用卢比交易您的比特币和其他资产 | `apiKey` |
| Huobi | `HuobiClient` | `https://huobiapi.github.io/docs/spot/v1/en/` | 塞舌尔的加密货币交易所 | `apiKey` |
| CoinStats | `CoinstatsClient` | `https://documenter.getpostman.com/view/5734027/RzZ6Hzr3?version=latest` | 加密追踪器 | `免 Key` |
| Coinlib | `CoinlibClient` | `https://coinlib.io/apidocs` | 加密货币价格 | `apiKey` |
| Messari | `MessariClient` | `https://messari.io/api` | 为数千种加密资产提供API端点 | `免 Key` |
| Brave NewCoin | `BraveNewcoinClient` | `https://bravenewcoin.com/developers` | 来自 200 多个交易所的实时和历史加密数据 | `apiKey` |
...
| EXMO | `ExmoClient` | `https://documenter.getpostman.com/view/10287440/SzYXWKPi` | 总部位于英国的加密货币交易所 | `apiKey` |
...
| Coinbase | `CoinbaseClient` | `https://developers.coinbase.com` | 比特币、比特币现金、莱特币和以太坊价格 | `apiKey` |
| PumpFunData | `PumpfundataClient` | `https://pumpfundata.com/docs` | 历史 Pump.fun 和 PumpSwap AMM 将数据交换为每小时的 Parquet 文件 | `apiKey` |
| CoinAPI | `CoinapiClient` | `https://docs.coinapi.io/` | 所有货币兑换都集成在一个 API 下 | `apiKey` |
| MercadoBitcoin | `MercadobitcoinClient` | `https://www.mercadobitcoin.com.br/api-doc/` | 巴西加密货币信息 | `免 Key` |
| Block | `BlockClient` | `https://block.io/docs/basic` | 比特币支付、钱包和交易数据 | `apiKey` |
| FTX | `FtxClient` | `https://docs.ftx.com/` | 完整的 REST、websocket 和 FTX API 以满足您的算法交易需求 | `apiKey` |
| CoinRanking | `CoinrankingClient` | `https://developers.coinranking.com/api/documentation` | 实时加密货币数据 | `apiKey` |
| CryptAPI | `CryptapiClient` | `https://docs.cryptapi.io/` | 加密货币支付处理器 | `免 Key` |
| Kraken | `KrakenClient` | `https://docs.kraken.com/rest/` | 加密货币交易所 | `apiKey` |
| WorldCoinIndex | `WorldcoinindexClient` | `https://www.worldcoinindex.com/apiservice` | 加密货币价格 | `apiKey` |
| dYdX | `DydxClient` | `https://docs.dydx.exchange/` | 去中心化加密货币交易所 | `apiKey` |
| Gemini | `GeminiClient` | `https://docs.gemini.com/rest-api/` | 加密货币交易所 | `免 Key` |
| INFURA Ethereum | `InfuraEthereumClient` | `https://infura.io/product/ethereum` | 与以太坊主网和多个测试网的交互 | `apiKey` |
| NovaDax | `NovadaxClient` | `https://doc.novadax.com/en-US/#introduction` | NovaDAX API 用于访问所有市场数据、交易管理端点 | `apiKey` |
| Alchemy Ethereum | `AlchemyEthereumClient` | `https://docs.alchemy.com/alchemy/` | 以太坊节点即服务提供商 | `apiKey` |
| VALR | `ValrClient` | `https://docs.valr.com/` | 总部位于南非的加密货币交易所 | `apiKey` |
| KuCoin | `KucoinClient` | `https://docs.kucoin.com/` | 加密货币交易平台 | `apiKey` |
| Technical Analysis | `TechnicalAnalysisClient` | `https://technical-analysis-api.com` | 加密货币价格和技术分析 | `apiKey` |
...
| Coinbase Pro | `CoinbaseProClient` | `https://docs.pro.coinbase.com/#api` | 加密货币交易平台 | `apiKey` |
| ZMOK | `ZmokClient` | `https://zmok.io` | 以太坊 JSON RPC API 和 Web3 提供商 | `免 Key` |
| Coinremitter | `CoinremitterClient` | `https://coinremitter.com/docs` | 加密货币支付和价格 | `apiKey` |
| icy.tools | `IcyToolsClient` | `https://developers.icy.tools/` | 基于 GraphQL 的 NFT API | `apiKey` |
| Poloniex | `PoloniexClient` | `https://docs.poloniex.com` | 美国数字资产交易所 | `apiKey` |
| CryptoCompare | `CryptocompareClient` | `https://www.cryptocompare.com/api#` | 加密货币比较 | `免 Key` |
| Hirak Exchange Rates | `HirakExchangeRatesClient` | `https://rates.hirak.site/` | 162种货币与300种加密货币之间的汇率每5分钟更新一次，准确，无限制 | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| Aletheia | `AletheiaClient` | `https://aletheiaapi.com/` | 内幕交易数据、财报电话分析、财务报表等 | `apiKey` |
| Financial Modeling Prep | `FinancialModelingPrepClient` | `https://site.financialmodelingprep.com/developer/docs` | 实时和历史库存数据 | `apiKey` |
| Alpha Vantage | `AlphaVantageClient` | `https://www.alphavantage.co/` | 实时和历史库存数据 | `apiKey` |
| Binlist | `BinlistClient` | `https://binlist.net/` | 对 IIN/BIN 信息数据库的公开访问 | `免 Key` |
| Billplz | `BillplzClient` | `https://www.billplz.com/api` | 支付平台 | `apiKey` |
| Econdb | `EcondbClient` | `https://www.econdb.com/api/` | 全球宏观经济数据 | `免 Key` |
| Marketstack | `MarketstackClient` | `https://marketstack.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers` | 实时、日内和历史市场数据 API | `apiKey` |
| IG | `IgClient` | `https://labs.ig.com/gettingstarted` | 点差交易和差价合约市场数据 | `apiKey` |
| Bank Data | `BankDataClient` | `https://apilayer.com/marketplace/bank_data-api` | 全球即时 IBAN 和 SWIFT 号码验证 | `apiKey` |
| Intrinio | `IntrinioClient` | `https://intrinio.com/` | 广泛的金融数据源选择 | `apiKey` |
| Real Time Finance | `RealTimeFinanceClient` | `https://github.com/Real-time-finance/finance-websocket-API/` | Websocket API 用于访问实时股票数据 | `apiKey` |
| Finage | `FinageClient` | `https://finage.co.uk` | Finage 是一家股票、货币、加密货币、指数和 ETF 实时和历史数据提供商 | `apiKey` |
...
| Boleto.Cloud | `BoletoCloudClient` | `https://boleto.cloud/` | 在巴西生成 boletos 的 api | `apiKey` |
| MercadoPago | `MercadopagoClient` | `https://www.mercadopago.com.br/developers/es/reference` | Mercado Pago API 参考 - 开发集成所需的所有信息 | `apiKey` |
| Hotstoks | `HotstoksClient` | `https://hotstoks.com?utm_source=public-apis` | 由 SQL 提供支持的股市数据 | `apiKey` |
| Mono | `MonoClient` | `https://mono.co/` | 连接用户的银行账户并访问非洲的交易数据 | `apiKey` |
| Tradier | `TradierClient` | `https://developer.tradier.com` | 美国股票/期权市场数据（延迟、盘中、历史） | `OAuth` |
...
| VAT Validation | `VatValidationClient` | `https://www.abstractapi.com/vat-validation-rates-api` | 验证增值税号并计算增值税率 | `apiKey` |
| Klarna | `KlarnaClient` | `https://docs.klarna.com/klarna-payments/api/payments-api/` | Klarna 支付和购物服务 | `apiKey` |
| IBANforge | `IbanforgeClient` | `https://api.ibanforge.com` | 超过 75 个国家/地区的 IBAN 验证和 BIC/SWIFT 查询，包含 121,000 多个银行条目 | `免 Key` |
| Moov | `MoovClient` | `https://docs.moov.io/api/` | Moov API 使平台可以轻松发送、接收和存储资金 | `apiKey` |
| SmartAPI | `SmartapiClient` | `https://smartapi.angelbroking.com/` | 访问<SmartAPI>集并创建端到端经纪服务 | `apiKey` |
| Twelve Data | `TwelveDataClient` | `https://twelvedata.com/` | 股市数据（实时和历史） | `apiKey` |
| StockData | `StockdataClient` | `https://www.StockData.org` | 实时、盘中和历史市场数据、新闻和情绪 API | `apiKey` |
| Tax Data | `TaxDataClient` | `https://apilayer.com/marketplace/tax_data-api` | 全球即时增值税号和税务验证 | `apiKey` |
| Alpaca | `AlpacaClient` | `https://alpaca.markets/docs/api-documentation/api-v2/market-data/alpaca-data-api-v2/` | 所有美国股票和 ETF 的实时和历史市场数据 | `apiKey` |
| OpenFIGI | `OpenfigiClient` | `https://www.openfigi.com/api` | Bloomberg LP 的股票、指数、期货、期权符号系统 | `apiKey` |
| EconPulse | `EconpulseClient` | `https://econpulse.io` | 实时经济数据 — CPI、PPI、能源、国债利率、BTC 溢价 | `apiKey` |
| Front Accounting APIs | `FrontAccountingApisClient` | `https://frontaccounting.com/fawiki/index.php?n=Devel.SimpleAPIModule` | Front Accounting 是一款适用于小型企业的多语言和多货币软件 | `OAuth` |
| Indian Mutual Fund | `IndianMutualFundClient` | `https://www.mfapi.in/` | 获取印度共同基金数据的完整历史 | `免 Key` |
| YNAB | `YnabClient` | `https://api.youneedabudget.com/` | 预算与规划 | `OAuth` |
| Styvio | `StyvioClient` | `https://www.Styvio.com` | 实时和历史股票数据以及当前股票情绪 | `apiKey` |
| Zoho Books | `ZohoBooksClient` | `https://www.zoho.com/books/api/v3/` | 专为您的企业打造的在线会计软件 | `OAuth` |
| Polygon | `PolygonClient` | `https://polygon.io/` | 历史股市数据 | `apiKey` |
| WallstreetBets | `WallstreetbetsClient` | `https://dashboard.nbshare.io/apps/reddit/api/` | WallstreetBets 股票评论情绪分析 | `免 Key` |
| Citi | `CitiClient` | `https://sandbox.developerhub.citi.com/api-catalog-list` | 所有花旗集团账户和对账单数据 API | `apiKey` |
| Plaid | `PlaidClient` | `https://www.plaid.com/docs` | 连接用户的银行账户并访问交易数据 | `apiKey` |
| Banco do Brasil | `BancoDoBrasilClient` | `https://developers.bb.com.br/home` | 所有巴西银行金融交易 API | `OAuth` |
...
| Blogger | `BloggerClient` | `https://developers.google.com/blogger/` | Blogger API 允许客户端应用程序查看和更新 Blogger 内容 | `OAuth` |
| Lanyard | `LanyardClient` | `https://github.com/Phineas/lanyard` | 通过 HTTP REST API 或 WebSocket 检索您在 Discord 上的状态 | `免 Key` |
| Disqus | `DisqusClient` | `https://disqus.com/api/docs/auth/` | 与 Disqus 数据通信 | `OAuth` |
| Full Contact | `FullContactClient` | `https://docs.fullcontact.com/` | 获取社交媒体资料和联系信息 | `OAuth` |
| Facebook | `FacebookClient` | `https://developers.facebook.com/` | Facebook 登录、在 FB 上分享、社交插件、分析等 | `OAuth` |
| Ayrshare | `AyrshareClient` | `https://www.ayrshare.com` | 用于发布、获取分析和管理多个用户社交媒体帐户的社交媒体 API | `apiKey` |
| Line | `LineClient` | `https://developers.line.biz/` | 线路登录、在线分享、社交插件等 | `OAuth` |
| Fuck Off as a Service | `FuckOffAsAServiceClient` | `https://www.foaas.com` | 要求某人滚蛋 | `免 Key` |
| NAVER | `NaverClient` | `https://developers.naver.com/main/` | NAVER 登录、在 NAVER 上分享、社交插件等 | `OAuth` |
| Saidit | `SaiditClient` | `https://www.saidit.net/dev/api` | 开源 Reddit 克隆 | `OAuth` |
| TikTok | `TiktokClient` | `https://developers.tiktok.com/doc/login-kit-web` | 获取TikTok平台上的用户信息和用户的视频帖子 | `OAuth` |
| Discord | `DiscordClient` | `https://discord.com/developers/docs/intro` | 为 Discord 制作机器人，将 Discord 集成到外部平台 | `OAuth` |
| Reddit | `RedditClient` | `https://www.reddit.com/dev/api` | 互联网主页 | `OAuth` |
| Hashnode | `HashnodeClient` | `https://hashnode.com` | 为开发者打造的博客平台 | `免 Key` |
| Kakao | `KakaoClient` | `https://developers.kakao.com/` | Kakao 登录、在 KakaoTalk 上分享、社交插件等 | `OAuth` |
| Twitch | `TwitchClient` | `https://dev.twitch.tv/docs` | 游戏串流API | `OAuth` |
| Product Hunt | `ProductHuntClient` | `https://api.producthunt.com/v2/docs` | 科技领域最佳新产品 | `OAuth` |
| LinkedIn | `LinkedinClient` | `https://docs.microsoft.com/en-us/linkedin/?context=linkedin/context` | 与 LinkedIn 进行所有数字集成的基础 | `OAuth` |
| Telegram MTProto | `TelegramMtprotoClient` | `https://core.telegram.org/api#getting-started` | 读取和写入电报数据 | `OAuth` |
| GetXAPI | `GetxapiClient` | `https://www.getxapi.com/` | 读取 Twitter / X 数据并通过 REST 发布推文、点赞、转发、关注、私信 | `apiKey` |
| Microsoft Graph | `MicrosoftGraphClient` | `https://docs.microsoft.com/en-us/graph/api/overview` | 访问 Microsoft 365、Windows 10 和企业移动性中的数据和情报 | `OAuth` |
| Telegram Bot | `TelegramBotClient` | `https://core.telegram.org/bots/api` | 适用于机器人的 MTProto API 的简化 HTTP 版本 | `apiKey` |
| Telegraph | `TelegraphClient` | `https://telegra.ph/api` | 轻松创建有吸引力的博客并进行分享 | `apiKey` |
| Tumblr | `TumblrClient` | `https://www.tumblr.com/docs/en/api/v2` | 读取和写入 Tumblr 数据 | `OAuth` |
| Instagram | `InstagramClient` | `https://www.instagram.com/developer/` | Instagram 登录、在 Instagram 上分享、社交插件等 | `OAuth` |
| vk | `VkClient` | `https://vk.com/dev/sites` | 读写vk数据 | `OAuth` |
| Trash Nothing | `TrashNothingClient` | `https://trashnothing.com/developer` | 一个免费回收社区，每天发布数千件免费物品 | `OAuth` |
| Pinterest | `PinterestClient` | `https://developers.pinterest.com/` | 世界思想目录 | `OAuth` |
| Meetup.com | `MeetupComClient` | `https://www.meetup.com/api/guide` | 来自 Meetup.com 的聚会数据 | `apiKey` |
| Open Collective | `OpenCollectiveClient` | `https://docs.opencollective.com/help/developers/api` | 获取开放集体数据 | `免 Key` |
| Cisco Spark | `CiscoSparkClient` | `https://developer.ciscospark.com` | 团队协作软件 | `OAuth` |
| Twitter | `TwitterClient` | `https://developer.twitter.com/en/docs` | 读取和写入 Twitter 数据 | `OAuth` |
| Foursquare | `FoursquareClient` | `https://developer.foursquare.com/` | 与 Foursquare 用户和地点互动（基于地理位置的签到、照片、提示、活动等） | `OAuth` |
| aztro | `AztroClient` | `https://aztro.sameerkumar.website/` | 昨天、今天和明天的每日星座信息 | `免 Key` |
| TamTam | `TamtamClient` | `https://dev.tamtam.chat/` | 用于与 TamTam 交互的 Bot API | `apiKey` |
| Slack | `SlackClient` | `https://api.slack.com/` | 团队即时通讯 | `OAuth` |
| Revolt | `RevoltClient` | `https://developers.revolt.chat/api/` | Revolt 开源 Discord 替代品 | `apiKey` |
...
| CARTO | `CartoClient` | `https://carto.com/` | 位置信息预测 | `apiKey` |
| Kaggle | `KaggleClient` | `https://www.kaggle.com/docs/api` | 创建数据集、笔记本并与之交互，并与 Kaggle 连接 | `apiKey` |
...
| Nasdaq Data Link | `NasdaqDataLinkClient` | `https://docs.data.nasdaq.com/` | 股市数据 | `apiKey` |
| Joshua Project | `JoshuaProjectClient` | `https://api.joshuaproject.net/` | 世界上基督跟随者最少的人群 | `apiKey` |
...
| Socrata | `SocrataClient` | `https://dev.socrata.com/` | 获取来自世界各地政府、非营利组织和非政府组织的开放数据 | `OAuth` |
| LinkPreview | `LinkpreviewClient` | `https://www.linkpreview.net` | 获取任何请求的 URL 的 JSON 格式摘要，其中包含标题、描述和预览图像 | `apiKey` |
| PeakMetrics | `PeakmetricsClient` | `https://rapidapi.com/peakmetrics-peakmetrics-default/api/peakmetrics-news` | 新闻文章和公共数据集 | `apiKey` |
| Black History Facts | `BlackHistoryFactsClient` | `https://www.blackhistoryapi.io/docs` | 贡献或搜索网络上最大的黑人历史事实数据库之一 | `apiKey` |
| Archive.org | `ArchiveOrgClient` | `https://archive.readme.io/docs` | 互联网档案馆 | `免 Key` |
| Yelp | `YelpClient` | `https://www.yelp.com/developers/documentation/v3` | 寻找本地企业 | `OAuth` |
| OpenCorporates | `OpencorporatesClient` | `http://api.opencorporates.com/documentation/API-Reference` | 许多国家的公司实体和董事的数据 | `apiKey` |
...
| Recreation Information Database | `RecreationInformationDatabaseClient` | `https://ridb.recreation.gov/` | 休闲区、联邦土地、历史古迹、博物馆和其他景点/资源（美国） | `apiKey` |
| AcreLens | `AcrelensClient` | `https://www.acrelens.com` | 适用于任何美国房产的土地适宜性评分 API：离网、农村、娱乐、投资 | `apiKey` |
| Wikidata | `WikidataClient` | `https://www.wikidata.org/w/api.php?action=help` | 由维基媒体基金会运营的协作编辑的知识库 | `OAuth` |
| Scoop.it | `ScoopItClient` | `http://www.scoop.it/dev` | 内容管理服务 | `apiKey` |
| GENESIS | `GenesisClient` | `https://www.destatis.de/EN/Service/OpenData/api-webservice.html` | 德国联邦统计局 | `OAuth` |
| openAFRICA | `OpenafricaClient` | `https://africaopendata.org/` | 非洲开放数据的大型数据集存储库 | `免 Key` |
| UPC database | `UpcDatabaseClient` | `https://upcdatabase.org/api` | 来自世界各地的超过 150 万个条形码编号 | `apiKey` |
...
| Enigma Public | `EnigmaPublicClient` | `https://developers.enigma.com/docs` | 最广泛的公共数据集合 | `apiKey` |
...
| Open Movie Database | `OpenMovieDatabaseClient` | `http://www.omdbapi.com/` | 电影信息 | `apiKey` |
| Catch The Show | `CatchTheShowClient` | `https://catchtheshow.herokuapp.com/api/documentation` | next-episode.net 的 REST API | `免 Key` |
| Simkl | `SimklClient` | `https://simkl.docs.apiary.io` | 电影、电视和动漫数据 | `apiKey` |
| TVDB | `TvdbClient` | `https://thetvdb.com/api-information` | 电视数据 | `apiKey` |
...
| JSON2Video | `Json2VideoClient` | `https://json2video.com` | 以编程方式创建和编辑视频：水印、调整大小、幻灯片、画外音、文本动画 | `apiKey` |
| uNoGS | `UnogsClient` | `https://rapidapi.com/unogs/api/unogsng` | 非官方 Netflix 在线全球搜索，在一处搜索所有 Netflix 地区 | `apiKey` |
| Game of Thrones Quotes | `GameOfThronesQuotesClient` | `https://gameofthronesquotes.xyz/` | 一些《权力的游戏》中的台词 | `免 Key` |
| TrailerAddict | `TraileraddictClient` | `https://www.traileraddict.com/trailerapi` | 轻松嵌入来自 TrailerAddict 的预告片 | `apiKey` |
| YouTube | `YoutubeClient` | `https://developers.google.com/youtube/` | 将 YouTube 功能添加到您的网站和应用程序 | `OAuth` |
| Trakt | `TraktClient` | `https://trakt.docs.apiary.io/` | 影视数据 | `apiKey` |
| Hyperserve | `HyperserveClient` | `https://hyperserve.io/` | 视频后端API：上传任意格式、转码为MP4、通过CDN传送 | `apiKey` |
| The Vampire Diaries | `TheVampireDiariesClient` | `https://vampire-diaries-api.netlify.app/` | 电视节目数据 | `apiKey` |
...
| Watchmode | `WatchmodeClient` | `https://api.watchmode.com/` | 用于查找电影和节目的流媒体可用性的 API | `apiKey` |
| Vimeo | `VimeoClient` | `https://developer.vimeo.com/` | Vimeo 开发者 API | `OAuth` |
| The Lord of the Rings | `TheLordOfTheRingsClient` | `https://the-one-api.dev/` | 指环王 API | `apiKey` |
| SWAPI | `SwapiClient` | `https://swapi.dev/` | 您想要的所有星球大战数据 | `免 Key` |
| STAPI | `StapiClient` | `http://stapi.co` | 有关《星际迷航》所有内容的信息 | `免 Key` |
| TMDb | `TmdbClient` | `https://www.themoviedb.org/documentation/api` | 基于社区的电影数据 | `apiKey` |
...
| Dailymotion | `DailymotionClient` | `https://developer.dailymotion.com/` | Dailymotion 开发者 API | `OAuth` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| Botd | `BotdClient` | `https://github.com/fingerprintjs/botd` | Botd 是一个用于 JavaScript 机器人检测的浏览器库 | `apiKey` |
| Application Environment Verification | `ApplicationEnvironmentVerificationClient` | `https://github.com/fingerprintjs/aev` | Android库和API用于验证用户设备的安全性，检测root设备和其他风险 | `apiKey` |
...
| BitWarden | `BitwardenClient` | `https://bitwarden.com/help/api/` | 最好的开源密码管理器 | `OAuth` |
| Censys | `CensysClient` | `https://search.censys.io/api` | 连接互联网的主机和设备的搜索引擎 | `apiKey` |
| Intelligence X | `IntelligenceXClient` | `https://github.com/IntelligenceX/SDK/blob/master/Intelligence%20X%20API.pdf` | 通过 Intelligence X 执行 OSINT | `apiKey` |
...
| HaveIBeenPwned | `HaveibeenpwnedClient` | `https://haveibeenpwned.com/API/v3` | 之前在数据泄露中暴露过的密码 | `apiKey` |
...
| GreyNoise | `GreynoiseClient` | `https://docs.greynoise.io/reference/get_v3-community-ip` | 查询 GreyNoise 数据集中的 IP 并检索完整 IP 上下文数据的子集 | `apiKey` |
| LoginRadius | `LoginradiusClient` | `https://www.loginradius.com/docs/` | 托管用户身份验证服务 | `apiKey` |
| HackerOne | `HackeroneClient` | `https://api.hackerone.com/` | 业界首个黑客 API，有助于提高创造性漏洞赏金狩猎的生产力 | `apiKey` |
| GitGuardian | `GitguardianClient` | `https://api.gitguardian.com/doc` | 扫描文件中的机密（API 密钥、数据库凭据） | `apiKey` |
| SecurityTrails | `SecuritytrailsClient` | `https://securitytrails.com/corp/apidocs` | 域和 IP 相关信息，例如当前和历史 WHOIS 和 DNS 记录 | `apiKey` |
| Bugcrowd | `BugcrowdClient` | `https://docs.bugcrowd.com/api/getting-started/` | Bugcrowd API，用于以编程方式交互和跟踪报告的问题 | `apiKey` |
...
| Spyse | `SpyseClient` | `https://spyse-dev.readme.io/reference/quick-start` | 访问所有互联网资产的数据并构建强大的攻击面管理应用程序 | `apiKey` |
...
| VulDB | `VuldbClient` | `https://vuldb.com/?doc.api` | VulDB API 允许启动对一项或多项以及事务机器人的查询 | `apiKey` |
...
| BinaryEdge | `BinaryedgeClient` | `https://docs.binaryedge.io/api-v2.html` | 提供对 BinaryEdge 40fy 扫描平台的访问 | `apiKey` |
| Complete Criminal Checks | `CompleteCriminalChecksClient` | `https://completecriminalchecks.com/Developers` | 提供来自美国所有州和波多黎各的罪犯数据 | `apiKey` |
| Shodan | `ShodanClient` | `https://developer.shodan.io/` | 互联网连接设备的搜索引擎 | `apiKey` |
| UK Police | `UkPoliceClient` | `https://data.police.uk/docs/` | 英国警方数据 | `免 Key` |
| FullHunt | `FullhuntClient` | `https://api-docs.fullhunt.io/#introduction` | 整个互联网的可搜索攻击面数据库 | `apiKey` |
...
| FingerprintJS Pro | `FingerprintjsProClient` | `https://dev.fingerprintjs.com/docs` | 欺诈检测 API 提供高度准确的浏览器指纹识别 | `apiKey` |
| Pulsedive | `PulsediveClient` | `https://pulsedive.com/api/` | 实时扫描、搜索和收集威胁情报数据 | `apiKey` |
| Privacy.com | `PrivacyComClient` | `https://privacy.com/developer/docs` | 生成特定于商家的一次性信用卡号，并链接回您的银行 | `apiKey` |
...
| CORE | `CoreClient` | `https://core.ac.uk/services#api` | 获取世界各地的开放获取研究论文 | `apiKey` |
...
| NASA ADS | `NasaAdsClient` | `https://ui.adsabs.harvard.edu/help/api/api-docs.html` | 美国宇航局天体物理数据系统 | `OAuth` |
| SHARE | `ShareClient` | `https://share.osf.io/api/v2/` | 关于研究和学术活动的免费、开放的数据集 | `免 Key` |
| Numbers | `NumbersClient` | `https://math.tools/api/numbers/` | 当天的数字、随机数、数字事实以及您想用数字做的任何其他事情 | `apiKey` |
...
| Materials Platform for Data Science | `MaterialsPlatformForDataScienceClient` | `https://mpds.io` | 材料科学的策划实验数据 | `apiKey` |
...
| Genius | `GeniusClient` | `https://docs.genius.com/` | 众包歌词和音乐知识 | `OAuth` |
| Bandcamp | `BandcampClient` | `https://bandcamp.com/developer` | 音乐商店 Bandcamp 的 API | `OAuth` |
| KKBOX | `KkboxClient` | `https://developer.kkbox.com` | 获取音乐库、播放列表、图表并在 KKBOX 平台上表演 | `OAuth` |
| Jamendo | `JamendoClient` | `https://developer.jamendo.com/v3.0/docs` | 音乐 | `OAuth` |
| Discogs | `DiscogsClient` | `https://www.discogs.com/developers/` | 音乐 | `OAuth` |
| LastFm | `LastfmClient` | `https://www.last.fm/api` | 音乐 | `apiKey` |
| Lyrics.ovh | `LyricsOvhClient` | `https://lyricsovh.docs.apiary.io` | 用于检索歌曲歌词的简单 API | `免 Key` |
| AI Mastering | `AiMasteringClient` | `https://aimastering.com/api_docs/` | 自动音乐母带处理 | `apiKey` |
| Mixcloud | `MixcloudClient` | `https://www.mixcloud.com/developers/` | 音乐 | `OAuth` |
| Openwhyd | `OpenwhydClient` | `https://openwhyd.github.io/openwhyd/API` | 下载精选的流媒体曲目播放列表（YouTube、SoundCloud 等...） | `免 Key` |
| TasteDive | `TastediveClient` | `https://tastedive.com/read/api` | 类似的艺术家 API（也适用于电影和电视节目） | `apiKey` |
| Songlink / Odesli | `SonglinkOdesliClient` | `https://www.notion.so/API-d0ebe08a5e304a55928405eb682f6741` | 获取可播放歌曲的所有服务 | `apiKey` |
| Freesound | `FreesoundClient` | `https://freesound.org/docs/api/` | 音乐样本 | `apiKey` |
| Songkick | `SongkickClient` | `https://www.songkick.com/developer/` | 音乐活动 | `apiKey` |
| SoundCloud | `SoundcloudClient` | `https://developers.soundcloud.com/docs/api/guide` | 借助 SoundCloud API，您可以构建应用程序来提供更多的能力来控制您的内容 | `OAuth` |
...
| Deezer | `DeezerClient` | `https://developers.deezer.com/api` | 音乐 | `OAuth` |
...
| TheAudioDB | `TheaudiodbClient` | `https://www.theaudiodb.com/api_guide.php` | 音乐 | `apiKey` |
| Audiomack | `AudiomackClient` | `https://www.audiomack.com/data-api/docs` | 流媒体音乐中心 Audiomack 的 API | `OAuth` |
| Sunor | `SunorClient` | `https://docs.sunor.cc` | 通过 Suno 的人工智能音乐生成 API，提供即用即付积分 | `apiKey` |
| 7digital | `Api7DigitalClient` | `https://docs.7digital.com/reference` | 音乐商店 7digital 的 Api | `OAuth` |
| Musixmatch | `MusixmatchClient` | `https://developer.musixmatch.com/` | 音乐 | `apiKey` |
| Spotify | `SpotifyClient` | `https://beta.developer.spotify.com/documentation/web-api/` | 查看 Spotify 音乐目录、管理用户的音乐库、获取推荐等 | `OAuth` |
| Phishin | `PhishinClient` | `https://phish.in/api-docs` | 即兴摇滚乐队 Phish 的合法现场录音的网络存档 | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| API-FOOTBALL | `ApiFootballClient` | `https://www.api-football.com/documentation-v3` | 获取有关足球联赛和杯赛的信息 | `apiKey` |
...
| Cloudbet | `CloudbetClient` | `https://www.cloudbet.com/api/` | 官方 Cloudbet API 提供实时体育赔率和投注 API，以编程方式下注 | `apiKey` |
...
| ApiMedic | `ApimedicClient` | `https://apimedic.com/` | ApiMedic 主要为患者提供医疗症状检查 API | `apiKey` |
| Fitbit | `FitbitClient` | `https://dev.fitbit.com/` | Fitbit 信息 | `OAuth` |
| Football | `FootballClient` | `https://rapidapi.com/GiulianoCrescimbeni/api/football98/` | 一个简单的开源足球 API，用于获取球队的统计数据、最佳得分手等 | `X-Mashape-Key` |
| Strava | `StravaClient` | `https://strava.github.io/api/` | 与运动员、活动等保持联系 | `OAuth` |
...
| Premier League Standings | `PremierLeagueStandingsClient` | `https://rapidapi.com/heisenbug/api/premier-league-live-scores/` | 当前所有英超联赛积分榜和统计数据 | `apiKey` |
| TheSportsDB | `ThesportsdbClient` | `https://www.thesportsdb.com/api.php` | 众包体育数据和艺术品 | `apiKey` |
| Squiggle | `SquiggleClient` | `https://api.squiggle.com.au` | 澳大利亚橄榄球联赛比赛的赛程、结果和预测 | `免 Key` |
| CollegeFootballData.com | `CollegefootballdataComClient` | `https://collegefootballdata.com` | 非官方详细的美国大学橄榄球统计、记录和结果 API | `apiKey` |
| RacingHub | `RacinghubClient` | `https://racinghub.net/api/v1/docs#/` | 一级方程式历史数据和统计 | `免 Key` |
| Football-Data | `FootballDataClient` | `https://www.football-data.org` | 足球数据，包括比赛信息、球员、球队和比赛 | `X-Mashape-Key` |
| Tredict | `TredictClient` | `https://www.tredict.com/blog/oauth_docs/` | 获取和设置活动、健康数据等 | `OAuth` |
| Sport Data | `SportDataClient` | `https://sportdataapi.com` | 获取世界各地的体育数据 | `apiKey` |
| NBA Data | `NbaDataClient` | `https://rapidapi.com/api-sports/api/api-nba/` | 所有 NBA 统计数据、比赛、实时比分、排名、统计 | `apiKey` |
| Ergast F1 | `ErgastF1Client` | `http://ergast.com/mrd/` | 1950年世锦赛开始时的F1数据 | `免 Key` |
| Sportmonks Cricket | `SportmonksCricketClient` | `https://docs.sportmonks.com/cricket/` | 实时板球比分、球员统计数据和 Fantasy API | `apiKey` |
| Wger | `WgerClient` | `https://wger.de/en/software/api` | 锻炼管理器数据如练习、肌肉或设备 | `apiKey` |
...
| JCDecaux Bike | `JcdecauxBikeClient` | `https://developer.jcdecaux.com/` | 德高集团自助自行车 | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| ColorfulClouds | `ColorfulcloudsClient` | `https://open.caiyunapp.com/ColorfulClouds_Weather_API` | 天气 | `apiKey` |
| QWeather | `QweatherClient` | `https://dev.qweather.com/en/` | 基于位置的天气数据 | `apiKey` |
| AQICN | `AqicnClient` | `https://aqicn.org/api/` | 1000多个城市空气质量指数数据 | `apiKey` |
| Hong Kong Obervatory | `HongKongObervatoryClient` | `https://www.hko.gov.hk/en/abouthko/opendata_intro.htm` | 提供天气信息、地震信息、气候数据 | `免 Key` |
| Aemet | `AemetClient` | `https://opendata.aemet.es/centrodedescargas/inicio` | 来自西班牙的天气和预报数据 | `apiKey` |
...
| Meteorologisk Institutt | `MeteorologiskInstituttClient` | `https://api.met.no/weatherapi/documentation` | 天气和气候数据 | `User-Agent` |
...
| OpenWeatherMap | `OpenweathermapClient` | `https://openweathermap.org/api` | 天气 | `apiKey` |
| AccuWeather | `AccuweatherClient` | `https://developer.accuweather.com/apis` | 天气和预报数据 | `apiKey` |
| openSenseMap | `OpensensemapClient` | `https://api.opensensemap.org/` | 来自称为 senseBoxes 的个人气象站的数据 | `免 Key` |
| Foreca | `ForecaClient` | `https://developer.foreca.com` | 天气 | `OAuth` |
| WeatherAPI | `WeatherapiClient` | `https://www.weatherapi.com/` | 天气 API 以及天文学和地理定位 API 等其他内容 | `apiKey` |
| Oikolab | `OikolabClient` | `https://docs.oikolab.com` | 来自 NOAA 和 ECMWF 的 70 多年全球每小时历史和预报天气数据 | `apiKey` |
| wttr.in | `WttrInClient` | `https://wttr.in/:help` | 终端中的天气，支持 JSON 输出 | `免 Key` |
| Weatherstack | `WeatherstackClient` | `https://weatherstack.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers` | 实时和历史世界天气数据 API | `apiKey` |
| Yandex.Weather | `YandexWeatherClient` | `https://yandex.com/dev/weather/` | 评估特定地点的天气状况 | `apiKey` |
| Tomorrow | `TomorrowClient` | `https://docs.tomorrow.io` | 由专有技术提供支持的天气 API | `apiKey` |
| APIXU | `ApixuClient` | `https://www.apixu.com/doc/request.aspx` | 天气 | `apiKey` |
| Weatherbit | `WeatherbitClient` | `https://www.weatherbit.io/api` | 天气 | `apiKey` |
| Storm Glass | `StormGlassClient` | `https://stormglass.io/` | 来自多个来源的全球海洋天气 | `apiKey` |
| Micro Weather | `MicroWeatherClient` | `https://m3o.com/weather/api` | 实时天气预报和历史数据 | `apiKey` |
| IPMA | `IpmaClient` | `https://api.ipma.pt/open-data/` | 葡萄牙天气和气候数据 | `免 Key` |
| OpenUV | `OpenuvClient` | `https://www.openuv.io` | 实时紫外线指数预测 | `apiKey` |
...
| HG Weather | `HgWeatherClient` | `https://hgbrasil.com/status/weather` | 提供巴西城市的天气预报数据 | `apiKey` |
...
| CMS.gov | `CmsGovClient` | `https://data.cms.gov/provider-data/` | 从 CMS 获取数据 - medicare.gov | `apiKey` |
...
| openFDA | `OpenfdaClient` | `https://open.fda.gov` | FDA 有关药品、设备和食品的公开数据 | `apiKey` |
...
| Orion Health | `OrionHealthClient` | `https://developer.orionhealth.io/` | 医疗平台，允许开发针对不同医疗场景的应用程序 | `OAuth` |
| Nutritionix | `NutritionixClient` | `https://developer.nutritionix.com/` | 世界上最大的经过验证的营养数据库 | `apiKey` |
...
| FoodData Central | `FooddataCentralClient` | `https://fdc.nal.usda.gov/` | 国家营养标准参考数据库 | `apiKey` |
| Lexigram | `LexigramClient` | `https://docs.lexigram.io/` | NLP 从文本中提取临床概念的提及，提供临床本体论的访问 | `apiKey` |
| Open Disease | `OpenDiseaseClient` | `https://disease.sh/` | 当前病例以及有关 COVID-19 和流感的更多内容的 API | `免 Key` |
| Infermedica | `InfermedicaClient` | `https://developer.infermedica.com/docs/` | 基于 NLP 的症状检查器和患者分类 API，用于通过文本进行健康诊断 | `apiKey` |
...
| Edamam | `EdamamClient` | `https://developer.edamam.com/` | 具有食谱搜索功能的食品和营养数据 API | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| Airtable | `AirtableClient` | `https://airtable.com/api` | 与 Airtable 集成 | `apiKey` |
| Asana | `AsanaClient` | `https://developers.asana.com/docs` | 以编程方式访问体式系统中的所有数据 | `apiKey` |
| CraftMyPDF | `CraftmypdfClient` | `https://craftmypdf.com` | 使用拖放式编辑器和简单的 API 从模板生成 PDF 文档 | `apiKey` |
| Api2Convert | `Api2ConvertClient` | `https://www.api2convert.com/` | 在线文件转换API | `apiKey` |
| Todoist | `TodoistClient` | `https://developer.todoist.com` | 待办事项列表 | `OAuth` |
| Notion | `NotionClient` | `https://developers.notion.com/docs/getting-started` | 与概念整合 | `OAuth` |
| PandaDoc | `PandadocClient` | `https://developers.pandadoc.com` | DocGen 和电子签名 API | `apiKey` |
| apilayer pdflayer | `ApilayerPdflayerClient` | `https://pdflayer.com` | HTML/URL 转 PDF | `apiKey` |
| Code::Stats | `CodeStatsClient` | `https://codestats.net/api-docs` | 程序员的自动时间跟踪 | `apiKey` |
| Html2PDF | `Html2PdfClient` | `https://html2pdf.app/` | HTML/URL 转 PDF | `apiKey` |
| Vector Express v2.0 | `VectorExpressV20Client` | `https://vector.express` | 免费矢量文件转换API | `免 Key` |
| Renderly | `RenderlyClient` | `https://renderlyapi.com` | 基于 Chromium 构建的 HTML 到 PDF 转换 API | `apiKey` |
| Flowdash | `FlowdashClient` | `https://docs.flowdash.com/docs/api-introduction` | 自动化业务工作流程 | `apiKey` |
| Cloudmersive Document and Data Conversion | `CloudmersiveDocumentAndDataConversionClient` | `https://cloudmersive.com/convert-api` | HTML/URL 到 PDF/PNG、Office 文档到 PDF、图像转换 | `apiKey` |
| Podio | `PodioClient` | `https://developers.podio.com` | 文件共享和生产力 | `OAuth` |
| ClickUp | `ClickupClient` | `https://clickup.com/api` | ClickUp 是一款强大的、基于云的项目管理工具，可提高生产力 | `OAuth` |
| BuildPDF | `BuildpdfClient` | `https://buildpdf.co/api/docs` | 将 HTML、图像和文本转换为 PDF | `apiKey` |
| JIRA | `JiraClient` | `https://developer.atlassian.com/server/jira/platform/rest-apis/` | JIRA 是一种专有的问题跟踪产品，允许错误跟踪和敏捷项目管理 | `OAuth` |
| staffSign | `StaffsignClient` | `https://staffsign.de/docs` | 数字雇佣合同 API，为人力资源和人员配置提供 QES/eIDAS 支持 | `apiKey` |
| Zube | `ZubeClient` | `https://zube.io/docs/api` | 全栈项目管理 | `OAuth` |
| Clockify | `ClockifyClient` | `https://clockify.me/developers-api` | Clockify 基于 REST 的 API 可用于向其中推送/拉取数据，并将其与其他系统集成 | `apiKey` |
| CloudConvert | `CloudconvertClient` | `https://cloudconvert.com/api/v2` | 用于音频、视频、文档、电子书、存档、图像、电子表格、演示文稿的在线文件转换器 | `apiKey` |
| PrexView | `PrexviewClient` | `https://prexview.com` | 将 XML 或 JSON 数据转换为 PDF、HTML 或图像 | `apiKey` |
| WakaTime | `WakatimeClient` | `https://wakatime.com/developers` | 程序员的自动时间跟踪排行榜 | `免 Key` |
| Smart Image Enhancement | `SmartImageEnhancementClient` | `https://apilayer.com/marketplace/image_enhancement-api` | 通过多种超分辨率算法向图像添加细节来执行图像升级 | `apiKey` |
| Restpack | `RestpackClient` | `https://restpack.io/` | 提供屏幕截图、HTML 转 PDF 和内容提取 API | `apiKey` |
...
| Mattermost | `MattermostClient` | `https://api.mattermost.com/` | 用于开发者协作的开源平台 | `OAuth` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| Flickr | `FlickrClient` | `https://www.flickr.com/services/api/` | Flickr 服务 | `OAuth` |
| Google Photos | `GooglePhotosClient` | `https://developers.google.com/photos` | 将 Google 相册与您的应用或设备集成 | `OAuth` |
...
| Pexels | `PexelsClient` | `https://www.pexels.com/api/` | 免费照片和视频 | `apiKey` |
| Pixabay | `PixabayClient` | `https://pixabay.com/sk/service/about/api/` | 摄影 | `apiKey` |
| Duply | `DuplyClient` | `https://duply.co/docs#getting-started-api` | 更智能、更快速地生成、编辑、缩放和管理图像和视频 | `apiKey` |
| PhotoRoom | `PhotoroomClient` | `https://www.photoroom.com/api/` | 从图像中删除背景 | `apiKey` |
| CheetahO | `CheetahoClient` | `https://cheetaho.com/docs/getting-started/` | 照片优化和调整大小 | `apiKey` |
| ObjectCut | `ObjectcutClient` | `https://objectcut.com/` | 图像背景去除 | `apiKey` |
| Giphy | `GiphyClient` | `https://developers.giphy.com/docs/` | 获取你所有的 GIF 动图 | `apiKey` |
| Remove.bg | `RemoveBgClient` | `https://www.remove.bg/api` | 图像背景去除 | `apiKey` |
...
| shutterstock | `ShutterstockClient` | `https://api-reference.shutterstock.com/` | 图库照片和视频 | `OAuth` |
| APITemplate.io | `ApitemplateIoClient` | `https://apitemplate.io` | 使用简单的 API 从模板动态生成图像和 PDF | `apiKey` |
| Dagpi | `DagpiClient` | `https://dagpi.xyz` | 图像操纵和处理 | `apiKey` |
| Imgur | `ImgurClient` | `https://apidocs.imgur.com/` | 图片 | `OAuth` |
| PlaceKeanu | `PlacekeanuClient` | `https://placekeanu.com/` | 可调整大小的基努·里维斯占位符图像，带有灰度和年轻基努选项 | `免 Key` |
| Webdam | `WebdamClient` | `https://www.damsuccess.com/hc/en-us/articles/202134055-REST-API` | 图片 | `OAuth` |
| Imsea | `ImseaClient` | `https://imsea.herokuapp.com/` | 免费图片搜索 | `免 Key` |
| DynaPictures | `DynapicturesClient` | `https://dynapictures.com/docs/` | 在几分钟内生成数百张个性化图像 | `apiKey` |
| Image Upload | `ImageUploadClient` | `https://apilayer.com/marketplace/image_upload-api` | 图像优化 | `apiKey` |
| Wallhaven | `WallhavenClient` | `https://wallhaven.cc/help/api` | 壁纸 | `apiKey` |
| Sirv | `SirvClient` | `https://apidocs.sirv.com/` | 图像管理解决方案，例如优化、操作、托管 | `apiKey` |
| Getty Images | `GettyImagesClient` | `http://developers.gettyimages.com/en/` | 使用世界上最强大的图像构建应用程序 | `OAuth` |
| Unsplash | `UnsplashClient` | `https://unsplash.com/developers` | 摄影 | `OAuth` |
...
| eBird | `EbirdClient` | `https://documenter.getpostman.com/view/664302/S1ENwy59` | 检索某个区域内最近或值得注意的观鸟观测结果 | `apiKey` |
...
| Petfinder | `PetfinderClient` | `https://www.petfinder.com/developers/` | Petfinder 致力于帮助宠物找到家，这是领养宠物的另一种资源 | `apiKey` |
| Cat Facts | `CatFactsClient` | `https://alexwohlbruck.github.io/cat-facts/` | 每日猫知识 | `免 Key` |
| AdoptAPet | `AdoptapetClient` | `https://www.adoptapet.com/public/apis/pet_list.html` | 帮助领养宠物的资源 | `apiKey` |
...
| Cats | `CatsClient` | `https://docs.thecatapi.com/` | 猫的照片来自Tumblr | `apiKey` |
| The Dog | `TheDogClient` | `https://thedogapi.com/` | 一项关于狗的公共服务，在制作您喜欢的新应用程序、网站或服务时免费使用 | `apiKey` |
...
| Amanah Sunnah | `AmanahSunnahClient` | `https://sunnah.amanahagent.cloud/developers` | 对《古兰经》、《圣训》、《Tafsir》和 18K+ Rijal 叙述者进行语义搜索 | `apiKey` |
...
| The Bible | `TheBibleClient` | `https://docs.api.bible` | 圣经中你需要的一切都集中在一个可发现的地方 | `apiKey` |
| Google Books | `GoogleBooksClient` | `https://developers.google.com/books/` | 书籍 | `OAuth` |
...
| Ganjoor | `GanjoorClient` | `https://api.ganjoor.net` | 经典波斯诗歌作品，包括相关手稿、朗诵和音乐曲目 | `OAuth` |
...
| Bhagavad Gita | `BhagavadGitaClient` | `https://bhagavadgita.io/api` | 薄伽梵歌文本 | `OAuth` |
| A Bíblia Digital | `ABBliaDigitalClient` | `https://www.abibliadigital.com.br/en` | 不用担心管理多个版本的圣经 | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| DeepAI | `DeepaiClient` | `https://deepai.org/` | 提供用于文本生成、图像处理等的人工智能驱动的 API | `apiKey` |
| AI For Thai | `AiForThaiClient` | `https://aiforthai.in.th/index.php` | 免费各种泰语AI API | `apiKey` |
| Hugging Face | `HuggingFaceClient` | `https://huggingface.co` | 具有用于 NLP、计算机视觉和音频的推理 API 的 AI 模型中心 | `apiKey` |
| Groq | `GroqClient` | `https://console.groq.com/docs/quickstart` | 具有免费套餐的快速 AI 推理 API，支持 Llama、Mixtral、Gemma 模型 | `apiKey` |
| Inferdo | `InferdoClient` | `https://rapidapi.com/user/inferdo` | 计算机视觉服务，例如面部检测、图像标记、NSFW 分类 | `apiKey` |
| Keen IO | `KeenIoClient` | `https://keen.io/` | 数据分析 | `apiKey` |
| Clarifai | `ClarifaiClient` | `https://docs.clarifai.com/api-guide/api-overview` | 计算机视觉 | `OAuth` |
| Cloudmersive | `CloudmersiveClient` | `https://www.cloudmersive.com/image-recognition-and-processing-api` | 图像字幕、人脸识别、NSFW 分类 | `apiKey` |
| Roboflow Universe | `RoboflowUniverseClient` | `https://universe.roboflow.com` | 预先训练的计算机视觉模型 | `apiKey` |
| Perspective | `PerspectiveClient` | `https://perspectiveapi.com` | NLP API 返回文本有毒、淫秽、侮辱或威胁的概率 | `apiKey` |
| EXUDE-API | `ExudeApiClient` | `http://uttesh.com/exude-api/` | 用于从文本数据中过滤停止词、词干词的主要方法 | `免 Key` |
| Time Door | `TimeDoorClient` | `https://timedoor.io` | 时间序列分析 API | `apiKey` |
| TensorFeed | `TensorfeedClient` | `https://tensorfeed.ai/developers` | 实时人工智能新闻、模型定价、服务状态和代理活动源 | `免 Key` |
| Imagga | `ImaggaClient` | `https://imagga.com/` | 图像识别解决方案，例如标记、视觉搜索、NSFW 审核 | `apiKey` |
| Dialogflow | `DialogflowClient` | `https://cloud.google.com/dialogflow/docs/` | 自然语言处理 | `apiKey` |
| WolframAlpha | `WolframalphaClient` | `https://products.wolframalpha.com/api/` | 使用数据和算法提供问题的具体答案 | `apiKey` |
| Unplugg | `UnpluggClient` | `https://unplu.gg/test_api.html` | 时间序列数据的预测 API | `apiKey` |
| Deepcode | `DeepcodeClient` | `https://www.deepcode.ai` | 人工智能进行代码审查 | `免 Key` |
| SkyBiometry | `SkybiometryClient` | `https://skybiometry.com/documentation/` | 人脸检测、人脸识别和人脸分组 | `apiKey` |
| Irisnet | `IrisnetClient` | `https://irisnet.de/api/` | 实时内容审核 API，可实时阻止或模糊不需要的图像 | `apiKey` |
| Hirak FaceAPI | `HirakFaceapiClient` | `https://faceapi.hirak.site/` | 人脸检测、人脸识别+年龄估计/性别估计，准确，无配额限制 | `apiKey` |
| Machinetutors | `MachinetutorsClient` | `https://www.machinetutors.com/portfolio/MT_api.html` | 人工智能解决方案：视频/图像分类和标记、NSFW、图标/图像/音频搜索、NLP | `apiKey` |
| NLP Cloud | `NlpCloudClient` | `https://nlpcloud.io` | 使用 spaCy 和转换器进行 NER、情感、分类、摘要等的 NLP API | `apiKey` |
| MessengerX.io | `MessengerxIoClient` | `https://messengerx.rtfd.io` | 一个免费的 API，供开发人员构建基于 ML 的个性化聊天应用程序并从中获利 | `apiKey` |
...
| What's on the menu? | `WhatSOnTheMenuClient` | `http://nypl.github.io/menus-api/` | 纽约公共图书馆人工转录的历史菜单集 | `apiKey` |
| Chomp | `ChompClient` | `https://chompthis.com/api/` | 有关各种杂货产品和食品的数据 | `apiKey` |
| Spoonacular | `SpoonacularClient` | `https://spoonacular.com/food-api` | 食谱、食品和膳食计划 | `apiKey` |
...
| TheMealDB | `ThemealdbClient` | `https://www.themealdb.com/api.php` | 膳食食谱 | `apiKey` |
| Fruityvice | `FruityviceClient` | `https://www.fruityvice.com` | 各类水果数据 | `免 Key` |
| Edamam recipes | `EdamamRecipesClient` | `https://developer.edamam.com/edamam-docs-recipe-api` | 食谱搜索 | `apiKey` |
| RecipeAPI | `RecipeapiClient` | `https://recipeapi.io` | 食谱、配料、营养数据和烹饪说明 | `apiKey` |
| Tasty | `TastyClient` | `https://rapidapi.com/apidojo/api/tasty/` | 用于查询有关配方、计划、成分的数据的 API | `apiKey` |
| Edamam nutrition | `EdamamNutritionClient` | `https://developer.edamam.com/edamam-docs-nutrition-api` | 营养分析 | `apiKey` |
| TheCocktailDB | `ThecocktaildbClient` | `https://www.thecocktaildb.com/api.php` | 鸡尾酒配方 | `apiKey` |
...
| Untappd | `UntappdClient` | `https://untappd.com/api/docs` | 社交啤酒分享 | `OAuth` |
| Zestful | `ZestfulClient` | `https://zestfuldata.com/` | 解析食谱成分 | `apiKey` |
| Kroger | `KrogerClient` | `https://developer.kroger.com/reference` | 超市数据 | `apiKey` |
...
| Mockaroo | `MockarooClient` | `https://www.mockaroo.com/docs` | 生成 JSON、CSV、TXT、SQL 和 XML 格式的虚假数据 | `apiKey` |
| Mailsac | `MailsacClient` | `https://mailsac.com/docs/api` | 一次性电子邮件 | `apiKey` |
...
| Randommer | `RandommerClient` | `https://randommer.io/randommer-api` | 随机数据生成器 | `apiKey` |
...
| FakeJSON | `FakejsonClient` | `https://fakejson.com` | 生成测试数据和虚假数据的服务 | `apiKey` |
...
| AniList | `AnilistClient` | `https://github.com/AniList/ApiV2-GraphQL-Docs` | 动漫发现和追踪 | `OAuth` |
| AnimeFacts | `AnimefactsClient` | `https://chandan-02.github.io/anime-facts-rest-api/` | 动漫事实（超过 100 条） | `免 Key` |
| Danbooru Anime | `DanbooruAnimeClient` | `https://danbooru.donmai.us/wiki_pages/help:api` | 数千动漫艺术家数据库，寻找优秀动漫艺术 | `apiKey` |
...
| Kitsu | `KitsuClient` | `https://kitsu.docs.apiary.io/` | 动漫发现平台 | `OAuth` |
| AniDB | `AnidbClient` | `https://wiki.anidb.net/HTTP_API_Definition` | 动漫数据库 | `apiKey` |
| AnimeNewsNetwork | `AnimenewsnetworkClient` | `https://www.animenewsnetwork.com/encyclopedia/api.php` | 动漫行业新闻 | `免 Key` |
| MyAnimeList | `MyanimelistClient` | `https://myanimelist.net/clubs.php?cid=13727` | 动漫数据库和社区 | `OAuth` |
| MangaDex | `MangadexClient` | `https://api.mangadex.org/docs.html` | 漫画数据库和社区 | `apiKey` |
| Catboy | `CatboyClient` | `https://catboys.com/api` | Neko 图片、有趣的 GIF 等 | `免 Key` |
| Shikimori | `ShikimoriClient` | `https://shikimori.one/api/doc` | 动漫发现、追踪、论坛、费率 | `OAuth` |
| Mangapi | `MangapiClient` | `https://rapidapi.com/pierre.carcellermeunier/api/mangapi3/` | 将漫画页面从一种语言翻译成另一种语言 | `apiKey` |
...
| AniAPI | `AniapiClient` | `https://aniapi.com/docs/` | 动漫发现、流媒体和与追踪器同步 | `OAuth` |
...
| Harvard Art Museums | `HarvardArtMuseumsClient` | `https://github.com/harvardartmuseums/api-docs` | 艺术 | `apiKey` |
...
| Europeana | `EuropeanaClient` | `https://pro.europeana.eu/resources/apis/search` | 欧洲博物馆和画廊内容 | `apiKey` |
...
| Noun Project | `NounProjectClient` | `http://api.thenounproject.com/index.html` | 图标 | `OAuth` |
| Lordicon | `LordiconClient` | `https://lordicon.com/` | 带有预先完成的动画的图标 | `免 Key` |
| Cooper Hewitt | `CooperHewittClient` | `https://collection.cooperhewitt.org/api` | 史密森尼设计博物馆 | `apiKey` |
| Rijksmuseum | `RijksmuseumClient` | `https://data.rijksmuseum.nl/object-metadata/api/` | 国家博物馆数据 | `apiKey` |
| Word Cloud | `WordCloudClient` | `https://wordcloudapi.com/` | 轻松创建词云 | `apiKey` |
| Dribbble | `DribbbleClient` | `https://developer.dribbble.com` | 发现世界顶级设计师和创意人士 | `OAuth` |
...
| Iconfinder | `IconfinderClient` | `https://developer.iconfinder.com` | 图标 | `apiKey` |
...
| Dropbox | `DropboxClient` | `https://www.dropbox.com/developers` | 文件共享和存储 | `OAuth` |
| GoFile | `GofileClient` | `https://gofile.io/api` | 免费无限大小文件上传 | `apiKey` |
| File.io | `FileIoClient` | `https://www.file.io` | 超级简单的文件共享，方便、匿名、安全 | `免 Key` |
| ddownload | `DdownloadClient` | `https://ddownload.com/api` | 文件共享和存储 | `apiKey` |
| Gyazo | `GyazoClient` | `https://gyazo.com/api/docs` | 立即保存并分享屏幕截图 | `apiKey` |
| Box | `BoxClient` | `https://developer.box.com/` | 文件共享和存储 | `OAuth` |
| Pastebin | `PastebinClient` | `https://pastebin.com/doc_api` | 纯文本存储 | `apiKey` |
| Pinata | `PinataClient` | `https://docs.pinata.cloud/` | IPFS 固定服务 API | `apiKey` |
| Imgbb | `ImgbbClient` | `https://api.imgbb.com/` | 简单快捷的私密图片分享 | `apiKey` |
| Google Drive | `GoogleDriveClient` | `https://developers.google.com/drive/` | 文件共享和存储 | `OAuth` |
| The Null Pointer | `TheNullPointerClient` | `https://0x0.st` | 没有废话的文件托管和 URL 缩短服务 | `免 Key` |
| Quip | `QuipClient` | `https://quip.com/dev/automation/documentation` | 群组文件共享和存储 | `apiKey` |
| Pantry | `PantryClient` | `https://getpantry.cloud/` | 小型项目的免费 JSON 存储 | `免 Key` |
| Filestack | `FilestackClient` | `https://www.filestack.com` | Filestack 文件上传器和文件上传 API | `apiKey` |
| OneDrive | `OnedriveClient` | `https://developer.microsoft.com/onedrive` | 文件共享和存储 | `OAuth` |
| Storj | `StorjClient` | `https://docs.storj.io/dcs/` | 去中心化开源云存储 | `apiKey` |
| Web3 Storage | `Web3StorageClient` | `https://web3.storage/` | 1TB 空间免费文件共享和存储 | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| Email Validation | `EmailValidationClient` | `https://www.abstractapi.com/email-verification-validation-api` | 验证电子邮件地址的可送达性和垃圾邮件 | `apiKey` |
| Cloudmersive Validate | `CloudmersiveValidateClient` | `https://cloudmersive.com/validate-api` | 验证电子邮件地址、电话号码、增值税号码和域名 | `apiKey` |
| EmailJS | `EmailjsClient` | `https://www.emailjs.com/docs/` | 直接从客户端 JavaScript 发送电子邮件，无需后端服务器 | `apiKey` |
| mail.tm | `MailTmClient` | `https://docs.mail.tm` | 临时电子邮件服务 | `免 Key` |
| mail.gw | `MailGwClient` | `https://docs.mail.gw` | 10 分钟邮件 | `免 Key` |
| mailboxlayer | `MailboxlayerClient` | `https://mailboxlayer.com?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers` | 电子邮件地址验证 | `apiKey` |
| Guerrilla Mail | `GuerrillaMailClient` | `https://www.guerrillamail.com/GuerrillaMailAPI.html` | 一次性临时电子邮件地址 | `免 Key` |
| Mailtrap | `MailtrapClient` | `https://mailtrap.docs.apiary.io/#` | 用于安全测试从开发和暂存环境发送的电子邮件的服务 | `apiKey` |
...
| ImprovMX | `ImprovmxClient` | `https://improvmx.com/api` | 免费电子邮件转发服务的 API | `apiKey` |
| MailboxValidator | `MailboxvalidatorClient` | `https://www.mailboxvalidator.com/api-email-free` | 验证电子邮件地址以提高送达率 | `apiKey` |
| Disify | `DisifyClient` | `https://www.disify.com/` | 验证并检测一次性和临时电子邮件地址 | `免 Key` |
| PostStack | `PoststackClient` | `https://poststack.dev/docs` | 欧盟托管的电子邮件 API，用于交易和营销电子邮件，包含联系人、广播和分析 | `apiKey` |
| MailCheck.ai | `MailcheckAiClient` | `https://www.mailcheck.ai/#documentation` | 防止用户使用临时电子邮件地址注册 | `免 Key` |
| Sendgrid | `SendgridClient` | `https://docs.sendgrid.com/api-reference/` | 基于云的 SMTP 提供商，让您无需维护电子邮件服务器即可发送电子邮件 | `apiKey` |
| Verifier | `VerifierClient` | `https://verifier.meetchopra.com/docs#/` | 验证给定的电子邮件是否真实 | `apiKey` |
| Sendinblue | `SendinblueClient` | `https://developers.sendinblue.com/docs` | 提供与营销和/或交易电子邮件和/或 SMS 相关的解决方案的服务 | `apiKey` |
...
| Jooble | `JoobleClient` | `https://jooble.org/api/about` | 职位搜索引擎 | `apiKey` |
| ZipRecruiter | `ZiprecruiterClient` | `https://www.ziprecruiter.com/publishers` | 求职应用程序和网站 | `apiKey` |
| Arbeitsamt | `ArbeitsamtClient` | `https://jobsuche.api.bund.dev/` | 德国求职板聚合器“Arbeitsamt”的 API | `OAuth` |
| Careerjet | `CareerjetClient` | `https://www.careerjet.com/partners/api/` | 职位搜索引擎 | `apiKey` |
| HeroHunt People Search | `HerohuntPeopleSearchClient` | `https://www.herohunt.ai/people-search-api` | 在 LinkedIn 和 GitHub 上搜索 10 亿人的个人资料以寻找人才 | `apiKey` |
| Arbeitnow | `ArbeitnowClient` | `https://documenter.getpostman.com/view/18545278/UVJbJdKh` | 欧洲/远程求职板聚合器 API | `免 Key` |
| Juju | `JujuClient` | `http://www.juju.com/publisher/spec/` | 职位搜索引擎 | `apiKey` |
| Reed | `ReedClient` | `https://www.reed.co.uk/developers` | 工作板聚合器 | `apiKey` |
| Findwork | `FindworkClient` | `https://findwork.dev/developers/` | 求职板 | `apiKey` |
| AI Dev Jobs | `AiDevJobsClient` | `https://aidevboard.com/openapi.yaml` | 具有 REST、RSS 和 MCP 端点的 AI/ML 工程作业聚合器 | `免 Key` |
| Upwork | `UpworkClient` | `https://developers.upwork.com/` | 自由职业委员会和管理系统 | `OAuth` |
| Adzuna | `AdzunaClient` | `https://developer.adzuna.com/overview` | 工作板聚合器 | `apiKey` |
| The Muse | `TheMuseClient` | `https://www.themuse.com/developers/api/v2` | 工作委员会和公司简介 | `apiKey` |
| WhatJobs | `WhatjobsClient` | `https://www.whatjobs.com/affiliates` | 职位搜索引擎 | `apiKey` |
| USAJOBS | `UsajobsClient` | `https://developer.usajobs.gov/` | 美国政府职位委员会 | `apiKey` |
| Jobs2Careers | `Jobs2CareersClient` | `http://api.jobs2careers.com/api/spec.pdf` | 职位聚合器 | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| Feedbin | `FeedbinClient` | `https://github.com/feedbin/feedbin-api` | RSS阅读器 | `OAuth` |
...
| The Old Reader | `TheOldReaderClient` | `https://github.com/theoldreader/api` | RSS阅读器 | `apiKey` |
| New York Times | `NewYorkTimesClient` | `https://developer.nytimes.com/` | 纽约时报开发者网络 | `apiKey` |
| News | `NewsClient` | `https://newsapi.org/` | 目前在一系列新闻来源和博客上发布的头条新闻 | `apiKey` |
| Spaceflight News | `SpaceflightNewsClient` | `https://spaceflightnewsapi.net` | 航天相关新闻🚀 | `免 Key` |
| GNews | `GnewsClient` | `https://gnews.io/` | 从各种来源搜索新闻 | `apiKey` |
| Associated Press | `AssociatedPressClient` | `https://developer.ap.org/` | 搜索美联社的新闻和元数据 | `apiKey` |
| Trove | `TroveClient` | `https://trove.nla.gov.au/about/create-something/using-api` | 搜索澳大利亚国家图书馆收藏的数千份数字化报纸 | `apiKey` |
| Mediastack | `MediastackClient` | `https://mediastack.com?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers` | 用于实时新闻和博客文章的免费、简单的 REST API | `apiKey` |
| NewsX | `NewsxClient` | `https://rapidapi.com/machaao-inc-machaao-inc-default/api/newsx/` | 使用 ML 支持的摘要获取或搜索最新突发新闻 🤖 | `apiKey` |
| Currents | `CurrentsClient` | `https://currentsapi.services/` | 具有多语言支持的实时和历史全球新闻 | `apiKey` |
| Chronicling America | `ChroniclingAmericaClient` | `http://chroniclingamerica.loc.gov/about/api/` | 提供从国会图书馆获取数百万页美国历史报纸的权限 | `免 Key` |
| MarketAux | `MarketauxClient` | `https://www.marketaux.com/` | 带有标记的股票市场新闻 + 情绪和统计 JSON API | `apiKey` |
| NewsData | `NewsdataClient` | `https://newsdata.io/docs` | 新闻数据 API，用于来自知名新闻来源的实时突发新闻和头条新闻 | `apiKey` |
| TheNews | `ThenewsClient` | `https://www.thenewsapi.com/` | 聚合头条新闻、头条新闻和实时新闻 JSON API | `apiKey` |
| The Guardian | `TheGuardianClient` | `http://open-platform.theguardian.com/` | 访问卫报创建的所有内容，按标签和部分分类 | `apiKey` |
...
| Medium | `MediumClient` | `https://github.com/Medium/medium-api-docs` | 提供独特观点的读者和作家社区 | `OAuth` |
| Stoicism Quote | `StoicismQuoteClient` | `https://github.com/tlcheah2/stoic-quote-lambda-public-api` | 关于斯多葛主义的名言 | `免 Key` |
| Dev.to | `DevToClient` | `https://developers.forem.com/api` | 通过 API 访问 Forem 文章、用户和其他资源 | `apiKey` |
| Udemy(instructor) | `UdemyInstructorClient` | `https://www.udemy.com/developers/instructor/` | Udemy 讲师 API | `apiKey` |
...
| FavQs.com | `FavqsComClient` | `https://favqs.com/api` | FavQs 可让您收集、发现和分享您最喜欢的名言 | `apiKey` |
...
| Cutt.ly | `CuttLyClient` | `https://cutt.ly/api-documentation/cuttly-links-api` | URL缩短服务 | `apiKey` |
| Free Url Shortener | `FreeUrlShortenerClient` | `https://ulvis.net/developer.html` | 免费 URL 缩短器提供强大的 API 来与其他网站交互 | `免 Key` |
| TinyURL | `TinyurlClient` | `https://tinyurl.com/app/dev` | 缩短长网址 | `apiKey` |
| Clico | `ClicoClient` | `https://cli.com/swagger-ui/index.html?configUrl=/v3/api-docs/swagger-config` | URL缩短服务 | `apiKey` |
...
| Bitly | `BitlyClient` | `http://dev.bitly.com/get_started.html` | URL 缩短器和链接管理 | `OAuth` |
| Rebrandly | `RebrandlyClient` | `https://developers.rebrandly.com/v1/docs` | 用于共享品牌链接的自定义 URL 缩短器 | `apiKey` |
| Mgnet.me | `MgnetMeClient` | `http://mgnet.me/api.html` | Torrent URL 缩短 API | `免 Key` |
| Shrtlnk | `ShrtlnkClient` | `https://shrtlnk.dev/developer` | 简单高效的短链接创建 | `apiKey` |
| UrlBae | `UrlbaeClient` | `https://urlbae.com/developers` | 简单高效的短链接创建 | `apiKey` |
| RedirHub | `RedirhubClient` | `https://redirhub.com` | 使用自定义域、HTTPS、分析和 REST API 进行 URL 重定向管理 | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| mailjet | `MailjetClient` | `https://www.mailjet.com/` | 可以发送营销电子邮件，并且可以使用 API 发送以 MJML 或 HTML 制作的邮件模板 | `apiKey` |
| Mailchimp | `MailchimpClient` | `https://mailchimp.com/developer/` | 发送营销活动和交易邮件 | `apiKey` |
| Instatus | `InstatusClient` | `https://instatus.com/help/api` | 通过 HTTP REST API 在状态页面上发布和更新维护和事件 | `apiKey` |
| Apache Superset | `ApacheSupersetClient` | `https://superset.apache.org/docs/api` | 用于在 Superset 上管理 BI 仪表板和数据源的 API | `apiKey` |
| Google Analytics | `GoogleAnalyticsClient` | `https://developers.google.com/analytics/` | 收集、配置和分析您的数据以吸引合适的受众 | `OAuth` |
| Domainsdb.info | `DomainsdbInfoClient` | `https://domainsdb.info/` | 注册域名搜索 | `免 Key` |
| Gmail | `GmailClient` | `https://developers.google.com/gmail/api/` | 灵活、RESTful 访问用户收件箱 | `OAuth` |
| Square | `SquareClient` | `https://developer.squareup.com/reference/square` | 轻松付款、管理退款并帮助客户在线结帐 | `OAuth` |
| Freelancer | `FreelancerClient` | `https://developers.freelancer.com` | 雇用自由职业者来完成工作 | `OAuth` |
| Tomba email finder | `TombaEmailFinderClient` | `https://tomba.io/api` | 用于 B2B 销售和电子邮件营销的电子邮件查找器以及电子邮件验证器 | `apiKey` |
| Redash | `RedashClient` | `https://redash.io/help/user-guide/integrations-and-api/api` | 在 Redash 上访问您的查询和仪表板 | `apiKey` |
| markerapi | `MarkerapiClient` | `https://markerapi.com` | 商标检索 | `免 Key` |
| Trello | `TrelloClient` | `https://developers.trello.com/` | 帮助您组织项目并确定项目优先级的看板、列表和卡片 | `OAuth` |
| Smartsheet | `SmartsheetClient` | `https://smartsheet.redoc.ly/` | 允许您以编程方式访问 Smartsheet 数据和帐户信息 | `OAuth` |
| Charity Search | `CharitySearchClient` | `http://charityapi.orghunter.com/` | 非营利慈善数据 | `apiKey` |
| SwiftKanban | `SwiftkanbanClient` | `https://www.digite.com/knowledge-base/swiftkanban/article/api-for-swift-kanban-web-services/#restapi` | 看板软件，可视化工作，增加组织的交付时间、吞吐量和生产力 | `apiKey` |
| Clearbit Logo | `ClearbitLogoClient` | `https://clearbit.com/docs#logo-api` | 搜索公司徽标并将其嵌入您的项目中 | `apiKey` |
...
| ExchangeRate-API | `ExchangerateApiClient` | `https://www.exchangerate-api.com` | 免费货币兑换 | `apiKey` |
| Currencylayer | `CurrencylayerClient` | `https://currencylayer.com?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers` | 汇率和货币换算 | `apiKey` |
| CurrencyFreaks | `CurrencyfreaksClient` | `https://currencyfreaks.com/` | 通过每月 1K 请求的免费计划提供当前和历史货币汇率 | `apiKey` |
| Exchangeratesapi.io | `ExchangeratesapiIoClient` | `https://exchangeratesapi.io?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers` | 汇率与货币换算 | `apiKey` |
...
| Fixer | `FixerClient` | `https://fixer.io?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers` | 汇率和货币换算 | `apiKey` |
| VATComply.com | `VatcomplyComClient` | `https://www.vatcomply.com/documentation` | 汇率、地理位置和增值税号验证 | `免 Key` |
| Amdoren | `AmdorenClient` | `https://www.amdoren.com/currency-api/` | 包含超过 150 种货币的免费货币 API | `apiKey` |
| Bank of Russia | `BankOfRussiaClient` | `https://www.cbr.ru/development/SXML/` | 汇率和货币换算 | `免 Key` |
| 1Forge | `Api1ForgeClient` | `https://1forge.com/forex-data-api/api-documentation` | 外汇货币市场数据 | `apiKey` |
...
| CurrencyScoop | `CurrencyscoopClient` | `https://currencyscoop.com/api-documentation` | 实时和历史货币汇率 JSON API | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| Cloudmersive Natural Language Processing | `CloudmersiveNaturalLanguageProcessingClient` | `https://www.cloudmersive.com/nlp-api` | 自然语言处理和文本分析 | `apiKey` |
| Code Detection | `CodeDetectionClient` | `https://codedetectionapi.runtime.dev` | 检测、标记、格式化和丰富应用程序或数据管道中的代码 | `OAuth` |
| Audexum | `AudexumClient` | `https://audexum.com/docs` | 具有 43 种语音和 33 种语言的文本转语音 REST API | `apiKey` |
| Lecto Translation | `LectoTranslationClient` | `https://rapidapi.com/lecto-lecto-default/api/lecto-translation/` | 翻译 API 免费且价格合理 | `apiKey` |
| Detect Language | `DetectLanguageClient` | `https://detectlanguage.com/` | 检测文本语言 | `apiKey` |
| GeoScore | `GeoscoreClient` | `https://geoscoreapi.com` | 使用 0-100 GEO 分数和 8 个结构指标对 AI 搜索引文准备情况的内容进行评分 | `apiKey` |
| apilayer languagelayer | `ApilayerLanguagelayerClient` | `https://languagelayer.com/` | 语言检测 JSON API 支持 173 种语言 | `OAuth` |
| ELI | `EliClient` | `https://nlp.insightera.co.th/docs/v1.0` | 泰语自然语言处理工具 | `apiKey` |
| Google Cloud Natural | `GoogleCloudNaturalClient` | `https://cloud.google.com/natural-language/docs/` | 自然语言理解技术，包括情感、实体和语法分析 | `apiKey` |
| LibreTranslate | `LibretranslateClient` | `https://libretranslate.com/docs` | 具有 17 种可用语言的翻译工具 | `免 Key` |
| Tisane | `TisaneClient` | `https://tisane.ai/` | 文本分析，重点检测滥用内容和执法应用程序 | `OAuth` |
| Watson Natural Language Understanding | `WatsonNaturalLanguageUnderstandingClient` | `https://cloud.ibm.com/apidocs/natural-language-understanding/natural-language-understanding` | 用于高级文本分析的自然语言处理 | `OAuth` |
| Semantria | `SemantriaClient` | `https://semantria.readme.io/docs` | 具有情感分析、分类和命名实体提取的文本分析 | `OAuth` |
| Hirak OCR | `HirakOcrClient` | `https://ocr.hirak.site/` | 图片转文字-文字识别-从图片100多种语言，精准，无限请求 | `apiKey` |
| Hirak Translation | `HirakTranslationClient` | `https://translate.hirak.site/` | 在 21 种最常用语言之间进行翻译，准确，无限制的请求 | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| MalwareBazaar | `MalwarebazaarClient` | `https://bazaar.abuse.ch/api/` | 收集并共享恶意软件样本 | `apiKey` |
| Web of Trust | `WebOfTrustClient` | `https://support.mywot.com/hc/en-us/sections/360004477734-API-` | IP/域名/URL 信誉 | `apiKey` |
| VirusTotal | `VirustotalClient` | `https://docs.virustotal.com/reference/overview` | VirusTotal 文件/URL 分析 | `apiKey` |
| Google Safe Browsing | `GoogleSafeBrowsingClient` | `https://developers.google.com/safe-browsing/` | Google 链接/域标记 | `apiKey` |
| CAPEsandbox | `CapesandboxClient` | `https://capev2.readthedocs.io/en/latest/usage/api.html` | 恶意软件执行和分析 | `apiKey` |
| AbuseIPDB | `AbuseipdbClient` | `https://docs.abuseipdb.com/` | IP/域名/URL 信誉 | `apiKey` |
| URLhaus | `UrlhausClient` | `https://urlhaus-api.abuse.ch/` | 批量查询和下载恶意软件样本 | `免 Key` |
| AlienVault Open Threat Exchange (OTX) | `AlienvaultOpenThreatExchangeOtxClient` | `https://otx.alienvault.com/api` | IP/域名/URL 信誉 | `apiKey` |
| NoPhishy | `NophishyClient` | `https://rapidapi.com/Amiichu/api/exerra-phishing-check/` | 检查链接以查看它们是否是已知的网络钓鱼尝试 | `apiKey` |
| MalShare | `MalshareClient` | `https://malshare.com/doc.php` | 恶意软件档案/文件来源 | `apiKey` |
| URLScan.io | `UrlscanIoClient` | `https://urlscan.io/about-api/` | 扫描并分析 URL | `apiKey` |
| MalDatabase | `MaldatabaseClient` | `https://maldatabase.com/api-doc.html` | 提供恶意软件数据集和威胁情报源 | `apiKey` |
| Metacert | `MetacertClient` | `https://metacert.com/` | Metacert 链接标记 | `apiKey` |
| Scanii | `ScaniiClient` | `https://docs.scanii.com/` | 简单的 REST API，可以扫描提交的文档/文件是否存在威胁 | `apiKey` |
...
| Calendarific | `CalendarificClient` | `https://calendarific.com/` | 全球假期 | `apiKey` |
| Czech Namedays Calendar | `CzechNamedaysCalendarClient` | `https://svatky.adresa.info` | 查找姓名并返回命名日日期 | `免 Key` |
| Holidays | `HolidaysClient` | `https://holidayapi.com/` | 有关假期的历史数据 | `apiKey` |
| Google Calendar | `GoogleCalendarClient` | `https://developers.google.com/google-apps/calendar/` | 显示、创建和修改 Google 日历事件 | `OAuth` |
| Namedays Calendar | `NamedaysCalendarClient` | `https://nameday.abalin.net` | 提供多个国家的命名日 | `免 Key` |
| Public Holidays | `PublicHolidaysClient` | `https://www.abstractapi.com/holidays-api` | 通过 API 获取有关国家、地区和宗教节日的数据 | `apiKey` |
| Hebrew Calendar | `HebrewCalendarClient` | `https://www.hebcal.com/home/developer-apis` | 在公历和希伯来语之间转换，获取安息日和假日时间等 | `免 Key` |
| Checkiday - National Holiday | `CheckidayNationalHolidayClient` | `https://apilayer.com/marketplace/checkiday-api` | 行业领先的假期数据，包含 5,000 多个假期和数千种描述 | `apiKey` |
...
| Anycrap | `AnycrapClient` | `https://anycrap.shop/developers` | 超过 35,000 个 AI 生成的荒诞产品概念，包含名称、描述和图像 | `apiKey` |
...
| TasteDive | `TastediveClient` | `https://tastedive.com/read/api` | 基于内容的电影、音乐、电视节目、书籍、游戏和播客推荐 | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| IQAir | `IqairClient` | `https://www.iqair.com/air-pollution-data-api` | 空气质量和天气数据 | `apiKey` |
| OpenAQ | `OpenaqClient` | `https://docs.openaq.org/` | 露天空气质量数据 | `apiKey` |
...
| Carbon Interface | `CarbonInterfaceClient` | `https://docs.carboninterface.com/` | 用于计算常见二氧化碳排放活动的碳 (CO2) 排放估算的 API | `apiKey` |
| BreezoMeter Pollen | `BreezometerPollenClient` | `https://docs.breezometer.com/api-documentation/pollen-api/v2/` | 特定地点的每日花粉状况预测数据 | `apiKey` |
| Srp Energy | `SrpEnergyClient` | `https://srpenergy-api-client-python.readthedocs.io/en/latest/api.html` | Srp 客户的每小时使用能源报告 | `apiKey` |
| Danish data service Energi | `DanishDataServiceEnergiClient` | `https://www.energidataservice.dk/` | 向社会开放 Energinet 的能源数据 | `免 Key` |
| Climatiq | `ClimatiqClient` | `https://docs.climatiq.io` | 计算各种排放活动产生的环境足迹 | `apiKey` |
...
| Cloverly | `CloverlyClient` | `https://www.cloverly.com/carbon-offset-documentation` | API实时计算常见碳密集型活动的影响 | `apiKey` |
...
| Collins | `CollinsClient` | `https://api.collinsdictionary.com/api/v1/documentation/html/` | 双语词典和词库数据 | `apiKey` |
| Merriam-Webster | `MerriamWebsterClient` | `https://dictionaryapi.com/` | 词典和同义词库数据 | `apiKey` |
| OwlBot | `OwlbotClient` | `https://owlbot.info/` | 带有例句和照片的定义（如果有） | `apiKey` |
| Free Dictionary | `FreeDictionaryClient` | `https://dictionaryapi.dev/` | 定义、语音、发音、词性、示例、同义词 | `免 Key` |
| Wordnik | `WordnikClient` | `https://developer.wordnik.com` | 词典数据 | `apiKey` |
| Synonyms | `SynonymsClient` | `https://www.synonyms.com/synonyms_api.php` | 任何给定单词的同义词、同义词库和反义词信息 | `apiKey` |
...
| Lingua Robot | `LinguaRobotClient` | `https://www.linguarobot.io` | 单词定义、发音、同义词、反义词等 | `apiKey` |
| Indonesia Dictionary | `IndonesiaDictionaryClient` | `https://new-kbbi-api.herokuapp.com/` | 印度尼西亚词典很多单词 | `免 Key` |
| Words | `WordsClient` | `https://www.wordsapi.com/docs/` | 超过 150,000 个单词的定义和同义词 | `apiKey` |
| Oxford | `OxfordClient` | `https://developer.oxforddictionaries.com/` | 词典数据 | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| Digi-Key | `DigiKeyClient` | `https://www.digikey.com/en/resources/api-solutions` | 检索电子元件的价格和库存以及下订单 | `OAuth` |
| Best Buy | `BestBuyClient` | `https://bestbuyapis.github.io/api-documentation/#overview` | 产品、购买选项、类别、推荐、商店和商务 | `apiKey` |
| Shopee | `ShopeeClient` | `https://open.shopee.com/documents?version=1` | Shopee官方API，用于集成Shopee的各种服务 | `apiKey` |
| Lazada | `LazadaClient` | `https://open.lazada.com/doc/doc.htm` | 检索产品评级和卖家绩效指标 | `apiKey` |
| WooCommerce | `WoocommerceClient` | `https://woocommerce.github.io/woocommerce-rest-api-docs/` | WooCommerce REST API 用于在 WordPress 网站上以 JSON 格式创建、读取、更新和删除数据 | `apiKey` |
| Rappi | `RappiClient` | `https://dev-portal.rappi.com/` | 通过 Rappi 的应用程序管理订单 | `OAuth` |
| Octopart | `OctopartClient` | `https://octopart.com/api/v4/reference` | 用于制造、设计和采购的电子零件数据 | `apiKey` |
| Mercadolibre | `MercadolibreClient` | `https://developers.mercadolibre.cl/es_ar/api-docs-es` | 管理销售、广告、产品、服务和商店 | `apiKey` |
| Dummy Products | `DummyProductsClient` | `https://dummyproducts-api.herokuapp.com/` | 用于获取带有占位符图像的虚拟电子商务产品 JSON 数据的 api | `apiKey` |
| OLX Poland | `OlxPolandClient` | `https://developer.olx.pl/api/doc#section/` | 通过发布、管理广告以及与 OLX 用户沟通来与本地网站集成 | `apiKey` |
| Etsy | `EtsyClient` | `https://www.etsy.com/developers/documentation/getting_started/api_basics` | 管理商店并与列表互动 | `OAuth` |
| Tokopedia | `TokopediaClient` | `https://developer.tokopedia.com/openapi/guide/#/` | Tokopedia 的官方 API，用于集成 Tokopedia 的各种服务 | `OAuth` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| Etherscan | `EtherscanClient` | `https://etherscan.io/apis` | 以太坊浏览器API | `apiKey` |
| Steem | `SteemClient` | `https://developers.steem.io/` | 基于区块链的博客和社交媒体网站 | `免 Key` |
| The Graph | `TheGraphClient` | `https://thegraph.com` | 使用 GraphQL 查询以太坊等网络的索引协议 | `apiKey` |
| Watchdata | `WatchdataClient` | `https://docs.watchdata.io` | 提供对以太坊区块链的简单可靠的API访问 | `apiKey` |
| Chainpoint | `ChainpointClient` | `https://tierion.com/chainpoint/` | Chainpoint 是一个将数据锚定到比特币区块链的全球网络 | `免 Key` |
| Nownodes | `NownodesClient` | `https://nownodes.io/` | 通过 API 提供高质量连接的区块链即服务解决方案 | `apiKey` |
...
| Bitquery | `BitqueryClient` | `https://graphql.bitquery.io/ide` | 链上 GraphQL API 和 DEX API | `apiKey` |
| Covalent | `CovalentClient` | `https://www.covalenthq.com/docs/api/` | 多区块链数据聚合平台 | `apiKey` |
...
| Creative Commons Catalog | `CreativeCommonsCatalogClient` | `https://api.creativecommons.engineering/` | 在公开许可和公共领域的作品中搜索 | `OAuth` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| Pixela | `PixelaClient` | `https://pixe.la` | 用于记录和跟踪习惯或努力、例程的 API | `X-Mashape-Key` |
| PostNord | `PostnordClient` | `https://developer.postnord.com/api` | 提供有关瑞典和丹麦运输包裹的信息 | `apiKey` |
| WeCanTrack | `WecantrackClient` | `https://docs.wecantrack.com` | 自动在联属链接中放置子广告，将联属营销转化归因于点击数据 | `apiKey` |
| WhereParcel | `WhereparcelClient` | `https://whereparcel.com/docs` | 全球 60 多家承运商（USPS、FedEx、UPS、DHL 等）的统一包裹追踪 API | `apiKey` |
| PostalPinCode | `PostalpincodeClient` | `http://www.postalpincode.in/Api-Details` | 用于获取印度 Pincode 详细信息的 API | `免 Key` |
| Aftership | `AftershipClient` | `https://developers.aftership.com/reference/quick-start` | API 可有效更新、管理和跟踪货运 | `apiKey` |
...
| Correios | `CorreiosClient` | `https://cws.correios.com.br/ajuda` | 使用 Correio 的服务进行集成以提供信息并准备发货 | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| US Extract | `UsExtractClient` | `https://www.smarty.com/products/apis/us-extract-api` | 从包括电子邮件在内的任何文本中提取邮政地址 | `apiKey` |
| US Street Address | `UsStreetAddressClient` | `https://www.smarty.com/docs/cloud/us-street-api` | 验证并附加任何美国邮政地址的数据 | `apiKey` |
| PurgoMalum | `PurgomalumClient` | `http://www.purgomalum.com` | 针对亵渎和淫秽内容的内容验证器 | `免 Key` |
| US Autocomplete | `UsAutocompleteClient` | `https://www.smarty.com/docs/cloud/us-autocomplete-pro-api` | 通过实时地址建议快速输入地址数据 | `apiKey` |
| VATlayer | `VatlayerClient` | `https://vatlayer.com/?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers` | 增值税号验证 | `apiKey` |
| Lob.com | `LobComClient` | `https://lob.com/` | 美国地址验证 | `apiKey` |
...
| Helipaddy sites | `HelipaddySitesClient` | `https://helipaddy.com/api/` | 直升机和客运无人机着陆点目录、Helipaddy 数据等等 | `apiKey` |
| RevCarData | `RevcardataClient` | `https://revcardata.com` | 86,000 多个全球车辆规格和电动汽车指标 | `apiKey` |
| Mercedes-Benz | `MercedesBenzClient` | `https://developer.mercedes-benz.com/apis` | 远程信息处理数据、远程访问车辆功能、汽车配置器、定位服务经销商 | `apiKey` |
| Kelley Blue Book | `KelleyBlueBookClient` | `http://developer.kbb.com/#!/data/1-Default` | 车辆信息、定价、配置等等 | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| Auth0 | `Auth0Client` | `https://auth0.com` | 易于实施、适应性强的身份验证和授权平台 | `apiKey` |
| MojoAuth | `MojoauthClient` | `https://mojoauth.com` | 安全、现代的无密码身份验证平台 | `apiKey` |
| Warrant | `WarrantClient` | `https://warrant.dev/` | 用于授权和访问控制的 API | `apiKey` |
| GetOTP | `GetotpClient` | `https://otp.dev/en/docs/` | 快速实施 OTP 流程 | `apiKey` |
| Stytch | `StytchClient` | `https://stytch.com/` | 现代应用程序的用户基础设施 | `apiKey` |
| Micro User Service | `MicroUserServiceClient` | `https://m3o.com/user` | 用户管理和认证 | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| CircleCI | `CircleciClient` | `https://circleci.com/docs/api/v1-reference/` | 使用持续集成和持续交付实现软件开发流程自动化 | `apiKey` |
| Bitrise | `BitriseClient` | `https://api-docs.bitrise.io/` | 构建工具和流程集成以创建高效的开发管道 | `apiKey` |
| Azure DevOps Health | `AzureDevopsHealthClient` | `https://docs.microsoft.com/en-us/rest/api/resourcehealth` | 当 Azure 问题影响您的资源时，资源运行状况可帮助您诊断并获得支持 | `apiKey` |
| Buddy | `BuddyClient` | `https://buddy.works/docs/api/getting-started/overview` | 最快的持续集成和持续交付平台 | `OAuth` |
| Codeship | `CodeshipClient` | `https://docs.cloudbees.com/docs/cloudbees-codeship/latest/api-overview/` | Codeship 是一个云端持续集成平台 | `apiKey` |
| Travis CI | `TravisCiClient` | `https://docs.travis-ci.com/api/` | 将您的 GitHub 项目与 Travis CI 同步，以在几分钟内测试您的代码 | `apiKey` |
...
| Phone Validation | `PhoneValidationClient` | `https://www.abstractapi.com/phone-validation-api` | 验证全球电话号码 | `apiKey` |
| Cloudmersive Validate | `CloudmersiveValidateClient` | `https://cloudmersive.com/phone-number-validation-API` | 验证国际电话号码 | `apiKey` |
| Veriphone | `VeriphoneClient` | `https://veriphone.io` | 电话号码验证和运营商查找 | `apiKey` |
| Numlookup | `NumlookupClient` | `https://numlookupapi.com` | 覆盖全球的电话号码验证和运营商查找 API | `apiKey` |
| Numverify | `NumverifyClient` | `https://numverify.com?utm_source=Github&utm_medium=Referral&utm_campaign=Public-apis-repo-Best-sellers` | 电话号码验证 | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| EPO | `EpoClient` | `https://developers.epo.org/` | 欧洲专利检索系统API | `OAuth` |
| TIPO | `TipoClient` | `https://tiponet.tipo.gov.tw/Gazette/OpenData/OD/OD05.aspx?QryDS=API00` | 台湾专利检索系统API | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| Hackerearth | `HackerearthClient` | `https://www.hackerearth.com/docs/wiki/developers/v4/` | 用于编译和运行多种语言的代码 | `apiKey` |
| Codeforces | `CodeforcesClient` | `https://codeforces.com/apiHelp` | 访问 Codeforces 数据 | `apiKey` |
| Judge0 CE | `Judge0CeClient` | `https://ce.judge0.com/` | 在线代码执行系统 | `apiKey` |
| Mintlify | `MintlifyClient` | `https://docs.mintlify.com` | 用于以编程方式生成代码文档 | `apiKey` |
...
| API 名称 | 客户端类名 (Client Class) | 基础 URL (Base URL) | 功能描述 (Description) | 授权方式 |
| :--- | :--- | :--- | :--- | :---: |
| Eventbrite | `EventbriteClient` | `https://www.eventbrite.com/platform/api/` | 查找活动 | `OAuth` |
| SeatGeek | `SeatgeekClient` | `https://platform.seatgeek.com/` | 搜索活动、场地和表演者 | `apiKey` |
| Ticketmaster | `TicketmasterClient` | `http://developer.ticketmaster.com/products-and-docs/apis/getting-started/` | 搜索活动、景点或场地 | `apiKey` |
